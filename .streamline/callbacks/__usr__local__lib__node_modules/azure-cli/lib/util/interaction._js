...
__.extend(Interactor.prototype, {
  ...
  withProgress: function(label, action, callback) {
    ...
    var logger = {
      error: function(message) {
        logMsgs.push(function() {
          self.cli.output.error(message);
        });
      },
      info: function(message) {
        logMsgs.push(function() {
          self.cli.output.info(message);
        });
      },
      data: function(message) {
        logMsgs.push(function() {
          self.cli.output.data(message);
        });
      },
      warn: function(message) {
        logMsgs.push(function() {
          self.cli.output.warn(message);
        });
      }
    };
    action(logger, function() {
      p.end();
      logMsgs.forEach(function(lf) {
        lf();
      });
  ...
  promptPasswordIfNotGiven: function promptPasswordIfNotGiven__1(promptString, currentValue, _) {
    var value, __this = this;
    var __frame = {
      name: "promptPasswordIfNotGiven__1",
      line: 156
    };
    return __func(_, this, arguments, promptPasswordIfNotGiven__1, 2, __frame, function __$promptPasswordIfNotGiven__1() {
      return (function __$promptPasswordIfNotGiven__1(__then) {
        if (__.isUndefined(currentValue)) {
          return __this.promptPassword(promptString, __cb(_, __frame, 2, 23, function ___(__0, __1) {
            value = __1;
            return _(null, value);
          }, true));
        }
         else {
          return _(null, currentValue);
        }
        ;
      })(_);
    });
  ...
  promptPasswordOnceIfNotGiven: function promptPasswordOnceIfNotGiven__2(promptString, currentValue, _) {
    var value, __this = this;
    var __frame = {
      name: "promptPasswordOnceIfNotGiven__2",
      line: 171
    };
    return __func(_, this, arguments, promptPasswordOnceIfNotGiven__2, 2, __frame, function __$promptPasswordOnceIfNotGiven__2() {
      return (function __$promptPasswordOnceIfNotGiven__2(__then) {
        if (__.isUndefined(currentValue)) {
          return __this.promptPasswordOnce(promptString, __cb(_, __frame, 2, 23, function ___(__0, __1) {
            value = __1;
            return _(null, value);
          }, true));
        }
  ...
  promptIfNotGiven: function promptIfNotGiven__3(promptString, currentValue, _) {
    var value, __this = this;
    var __frame = {
      name: "promptIfNotGiven__3",
      line: 180
    };
    return __func(_, this, arguments, promptIfNotGiven__3, 2, __frame, function __$promptIfNotGiven__3() {
      return (function __$promptIfNotGiven__3(__then) {
        if (__.isUndefined(currentValue)) {
          return __this.prompt(promptString, __cb(_, __frame, 2, 23, function ___(__0, __1) {
            value = __1;
            return _(null, value);
          }, true));
        }
  ...
  chooseIfNotGiven: function chooseIfNotGiven__4(promptString, progressString, currentValue, valueProvider, _) {
    var progress, values, i, __this = this;
    var __frame = {
      name: "chooseIfNotGiven__4",
      line: 195
    };
    return __func(_, this, arguments, chooseIfNotGiven__4, 4, __frame, function __$chooseIfNotGiven__4() {
      return (function __$chooseIfNotGiven__4(__then) {
        if (__.isUndefined(currentValue)) {
          progress = __this.cli.interaction.progress(progressString);
          return valueProvider(__cb(_, __frame, 3, 19, function ___(__0, __1) {
            values = __1;
            progress.end();
            __this.cli.output.help(promptString);
            return __this.choose(values, __cb(_, __frame, 7, 19, function ___(__0, __2) {
              i = __2;
              return _(null, values[i]);
            }, true));
          }, true));
        }
         else {
  ...
  launchBrowser: function launchBrowser__5(url, _) {
    var cmd;
    var __frame = {
      name: "launchBrowser__5",
      line: 230
    };
    return __func(_, this, arguments, launchBrowser__5, 1, __frame, function __$launchBrowser__5() {
      log.info("Launching browser to", url);
      return (function __$launchBrowser__5(__then) {
        if ((process.env.OS !== undefined)) {
          cmd = util.format("start %s", url).replace(/&/g, "^&");
          return child_process.exec(cmd, __cb(_, __frame, 5, 20, __then, true));
        }
         else {
