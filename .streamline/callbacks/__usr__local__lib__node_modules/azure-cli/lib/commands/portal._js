...
exports.init = function(cli) {
  cli.command("portal").description($("Open the portal in a browser")).option("-e, --environment <environment>", $("the publish settings download environment")).option("-r, --realm <realm>", $("the organization's realm")).execute(function __1(options, _) {
    var targetUrl;
    var __frame = {
      name: "__1",
      line: 27
    ...
    return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
      ...
      return cli.interaction.launchBrowser(targetUrl, __cb(_, __frame, 2, 22, function __$__1() {
        _();
      }, true));
    });
  });
