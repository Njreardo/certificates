...
exports.init = function(cli) {
  ...
  environment.command("show [environment]").description($("Show an environment")).option("--environment <environment>", $("the environment name")).execute(function __1(environment, options, _) {
    var existingEnvironment, endpointsForDisplay, report;
    var __frame = {
      name: "__1",
      line: 51
    };
    return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
      return cli.interaction.promptIfNotGiven("Environment name: ", environment, __cb(_, __frame, 1, 36, function ___(__0, __1) {
        environment = __1;
        ...
        if (!existingEnvironment) {
          ...
          if (log.format().json) {
            ...
            report = fields.sort().filter(function(field) {
              return (field !== "name");
            }).map(function(field) {
              return [field,field,];
            });
  ...
  addCommand.execute(function __2(environment, options, _) {
    var existingEnvironment, update, newEnvironment;
    var __frame = {
      name: "__2",
      line: 117
    };
    return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      return cli.interaction.promptIfNotGiven("New Environment name: ", environment, __cb(_, __frame, 1, 36, function ___(__0, __1) {
        environment = __1;
        existingEnvironment = profile.current.getEnvironment(environment);
        if (existingEnvironment) {
  ...
  setCommand.execute(function __3(environment, options, _) {
    var updates, existingEnvironment;
    var __frame = {
      name: "__3",
      line: 145
    };
  ...
  environment.command("delete [environment]").description($("Delete an environment")).option("--environment <environment>", $("the environment name")).execute(function __4(environment, options, _) {
