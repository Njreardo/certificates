...
exports.init = function(cli) {
  ...
  function promptServiceNameIfNotGiven(options, servicename, serviceFilter, _) {
    var result;
    var __frame = {
      name: "promptServiceNameIfNotGiven",
      line: 60
    };
    return __func(_, this, arguments, promptServiceNameIfNotGiven, 3, __frame, function __$promptServiceNameIfNotGiven() {
      return cli.interaction.chooseIfNotGiven($("Mobile Service: "), $("Retrieving choices"), servicename, function(cb) {
        mobile.listServices(options, function(error, services) {
          ...
          ;
          cb(null, services.filter(serviceFilter).map(function(service) {
            return service.name;
          }));
        });
      }, __cb(_, __frame, 1, 33, function ___(__0, __1) {
        result = __1;
  ...
  function promptTableNameIfNotGiven(options, tableName, _) {
    var result;
    var __frame = {
      name: "promptTableNameIfNotGiven",
      line: 72
    };
    return __func(_, this, arguments, promptTableNameIfNotGiven, 2, __frame, function __$promptTableNameIfNotGiven() {
      return cli.interaction.chooseIfNotGiven($("Table: "), $("Retrieving choices"), tableName, function(cb) {
        mobile.listTables(options, function(error, tables) {
          ...
          ;
          cb(null, tables.map(function(table) {
            return table.name;
          }));
        });
      }, __cb(_, __frame, 1, 33, function ___(__0, __1) {
  ...
  function promptDomainIfNotGiven(options, domain, _) {
    var result;
    var __frame = {
      name: "promptDomainIfNotGiven",
      line: 84
    };
    return __func(_, this, arguments, promptDomainIfNotGiven, 2, __frame, function __$promptDomainIfNotGiven() {
      return cli.interaction.chooseIfNotGiven($("Domain: "), $("Retrieving choices"), domain, function(cb) {
        mobile.getDomains(options, function(error, domains) {
          ...
          ;
          cb(null, domains.map(function(domain) {
            return domain;
          }));
        });
      }, __cb(_, __frame, 1, 33, function ___(__0, __1) {
  ...
  function promptThumbprintIfNotGiven(options, thumbprint, _) {
    var result;
    var __frame = {
      name: "promptThumbprintIfNotGiven",
      line: 96
    };
    return __func(_, this, arguments, promptThumbprintIfNotGiven, 2, __frame, function __$promptThumbprintIfNotGiven() {
      return cli.interaction.chooseIfNotGiven($("Thumbprint: "), $("Retrieving choices"), thumbprint, function(cb) {
        mobile.getCertificates(options, function(error, certificates) {
          ...
          ;
          cb(null, certificates.map(function(certificate) {
  ...
  function promptIfNotGiven(prompt, value, _) {
    ...
    return __func(_, this, arguments, promptIfNotGiven, 2, __frame, function __$promptIfNotGiven() {
      return cli.interaction.promptIfNotGiven(prompt, value, __cb(_, __frame, 1, 33, function ___(__0, __1) {
        result = __1;
        if ((result.length === 0)) {
  ...
  function formatCrossDomainWhitelistForDisplay(crossDomainWhitelist) {
    ...
    if (crossDomainWhitelist) {
      if (Array.isArray(crossDomainWhitelist)) {
        var data = [];
        crossDomainWhitelist.forEach(function(host) {
          data.push(host.host);
        });
        result = data.join(",");
      }
  ...
  mobile.getSharedScripts = function mobile_getSharedScripts__1(options, _) {
    var files;
    var __frame = {
      name: "mobile_getSharedScripts__1",
      line: 574
    };
    return __func(_, this, arguments, mobile_getSharedScripts__1, 1, __frame, function __$mobile_getSharedScripts__1() {
      return mobile.getRepositorySharedFolder(options, __cb(_, __frame, 1, 23, function ___(__0, __1) {
        files = __1;
        return _(null, __.filter(files, function(file) {
          return (file.name.indexOf(".js", (file.length - 3)) !== -1);
        }));
      }, true));
    });
  };
  ...
  mobile.loadAllScripts = function mobile_loadAllScripts__2(options, _) {
    var results;
    var __frame = {
      name: "mobile_loadAllScripts__2",
      line: 607
    };
    return __func(_, this, arguments, mobile_loadAllScripts__2, 1, __frame, function __$mobile_loadAllScripts__2() {
      return async.parallel({
        table: function table__1(_) {
          var __frame = {
            name: "table__1",
            line: 609
          };
          return __func(_, this, arguments, table__1, 0, __frame, function __$table__1() {
            return mobile.getAllTableScripts(options, __cb(_, __frame, 0, 42, _, true));
          });
        },
        shared: function shared__2(_) {
          var __frame = {
            name: "shared__2",
            line: 610
          };
          return __func(_, this, arguments, shared__2, 0, __frame, function __$shared__2() {
            return mobile.getSharedScripts(options, __cb(_, __frame, 0, 43, _, true));
          });
        },
        scheduler: function scheduler__3(_) {
          var __frame = {
            name: "scheduler__3",
            line: 611
          };
          return __func(_, this, arguments, scheduler__3, 0, __frame, function __$scheduler__3() {
            return mobile.getSchedulerScripts(options, __cb(_, __frame, 0, 46, _, true));
          });
        },
        api: function api__4(_) {
          var __frame = {
            name: "api__4",
            line: 612
          };
          return __func(_, this, arguments, api__4, 0, __frame, function __$api__4() {
            return mobile.getCustomApis(options, __cb(_, __frame, 0, 40, _, true));
          });
        }
      }, __cb(_, __frame, 1, 24, function ___(__0, __5) {
        results = __5;
  ...
  mobile.register = function mobile_register__3(options, _) {
    var subscription, progress;
    var __frame = {
      name: "mobile_register__3",
      line: 1241
    };
    return __func(_, this, arguments, mobile_register__3, 1, __frame, function __$mobile_register__3() {
      subscription = profile.current.getSubscription(options.subscription);
      progress = cli.interaction.progress($("Registering for mobile services"));
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$mobile_register__3() {
            return subscription.registerProvider("mobileservice", __cb(_, __frame, 5, 19, function __$mobile_register__3() {
              _(null, null, true);
            }, true));
          });
  ...
  mobile.command("locations").description($("List available mobile service locations")).option("-s, --subscription <id>", $("the subscription id")).execute(function __4(options, _) {
    var progress, result;
    var __frame = {
      name: "__4",
      line: 1557
    ...
    return __func(_, this, arguments, __4, 1, __frame, function __$__4() {
      progress = cli.interaction.progress($("Getting mobile service locations"));
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$__4() {
            return mobile.getRegions(options, __cb(_, __frame, 4, 28, function ___(__0, __1) {
              result = __1;
              _(null, null, true);
            }, true));
          });
  ...
  mobile.command("create [servicename] [username] [password]").usage("[options] [servicename] [sqlAdminUsername] [sqlAdminPassword]").description($("Create a new mobile service")).option("-r, --sqlServer <sqlServer>", $("use existing SQL server")).option("-d, --sqlDb <sqlDb>", $("use existing SQL database")).option("-l, --location <location>", $("create the service in a particular location; run azure mobile locations to get available locations")).option("--sqlLocation <location>", $("create the SQL server in a particular location; defaults to mobile service location")).option("-s, --subscription <id>", $("the subscription id")).option("-b, --backend <backend>", $("backend of mobile service. \"node\" and \"dotnet\" are examples.")).option("-p, --push <push>", $("type of push; \"nh\" or \"legacy\" are allowed. \"nh\" will soon be the default for node service. ignored for dotnet services.")).execute(function __5(servicename, username, password, options, _) {
    ...
    return __func(_, this, arguments, __5, 4, __frame, function __$__5() {
      if (!options.backend) {
        options.backend = "Node";
      }
       else {
        if (((options.backend.toLowerCase() !== "node") && (options.backend.toLowerCase() !== "dotnet"))) {
          return _(new Error("Backend can only have two values: \"Node\" or \"DotNet\""));
        }
        ;
      }
      ;
      if ((options.sqlDb && !options.sqlServer)) {
        return _(new Error($("To use an existing SQL database, you must specify the name of an existing SQL server using the --sqlServer parameter.")));
      }
      ;
      ...
      if ((options.backend.toLowerCase() === "node")) {
        if ((!options.push || (((options.push.toLowerCase() !== "legacy") && (options.push.toLowerCase() !== "nh"))))) {
          return _(new Error("-p/--push is required and can only have two values: \"legacy\" or \"nh\""));
        }
        ;
        options.enhancedPush = ((options.push.toLowerCase() === "nh"));
      }
      ;
      return (function __$__5(__then) {
        if (!options.location) {
          return mobile.getRegions(options, __cb(_, __frame, 26, 32, function ___(__0, __1) {
            result = __1;
            if (((!Array.isArray(result) || (result.length === 0)) || !result[0].region)) {
              return _(new Error($("Unable to determine the default mobile service location.")));
            }
            ;
        ...
        return cli.interaction.promptIfNotGiven($("Mobile service name: "), servicename, __cb(_, __frame, 34, 48, function ___(__0, __2) {
          options.servicename = __2;
          if (((options.servicename.length < 2) || (options.servicename.length > 48))) {
            return _(new Error($("Service name must be between 2 and 48 characters.")));
          }
           else {
            if (!options.servicename.match(/^[a-zA-Z][0-9a-zA-Z-]*[0-9a-zA-Z]$/)) {
              return _(new Error($("Service name must start with a letter, contain only letters, numbers, and hyphens, and end with a letter or number.")));
            }
            ;
          }
          ;
          return cli.interaction.promptIfNotGiven($("SQL administrator user name: "), username, __cb(_, __frame, 42, 45, function ___(__0, __3) {
            options.username = __3;
            if (!isUsernameValid(options.username)) {
              return _(new Error($("Invalid username")));
            }
            ;
            return (function __$__5(__then) {
              if (options.sqlServer) {
                return cli.interaction.promptPasswordOnceIfNotGiven($("SQL administrator password: "), password, __cb(_, __frame, 48, 47, function ___(__0, __4) {
                  options.password = __4;
                  __then();
                }, true));
              }
               else {
                return cli.interaction.promptPasswordIfNotGiven($("SQL administrator password: "), password, __cb(_, __frame, 50, 47, function ___(__0, __5) {
                  options.password = __5;
                  __then();
                }, true));
              }
              ;
              ...
              if (!isPasswordValid(options.username, options.password)) {
                return _(new Error($("Invalid password")));
              }
              ;
              return mobile.register(options, __cb(_, __frame, 56, 17, function __$__5() {
                return mobile.createService(options, __cb(_, __frame, 57, 17, function __$__5() {
                  _();
                }, true));
              }, true));
            });
  ...
  mobile.command("delete [servicename] [username] [password]").description($("Delete a mobile service")).option("-d, --deleteData", $("delete all data from the database")).option("-a, --deleteAll", $("delete all data, SQL database, and SQL server")).option("-n, --deleteNotificationHubNamespace", $("delete associated Notification Hub namespace and entities")).option("-s, --subscription <id>", $("the subscription id")).option("-q, --quiet", $("do not prompt for confirmation")).execute(function __6(servicename, username, password, options, _) {
    var prompt, progress, result, resources, flat, proceed, success;
    var __frame = {
      name: "__6",
      line: 1694
    };
    return __func(_, this, arguments, __6, 4, __frame, function __$__6() {
      ...
      ;
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 18, 32, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress($("Getting mobile service details"));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__6() {
              return mobile.getMobileServiceApplication(options, __cb(_, __frame, 23, 28, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
          ...
          __tryCatch(_, function __$__6() {
            ...
            return (function __$__6(__then) {
              if (!options.quiet) {
                return cli.interaction.confirm(util.format($("Do you want to delete the mobile service %s? [y/n]: "), prompt), __cb(_, __frame, 40, 42, function ___(__0, __3) {
                  proceed = __3;
                  if (!proceed) {
              ...
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$__6() {
                    return mobile.deleteService(options, __cb(_, __frame, 50, 19, __then, true));
                  });
                })(function ___(e, __result) {
                  __catch(function __$__6() {
                    if (e) {
                      progress.end();
                  ...
                  return (function __$__6(__then) {
                    if (options.deleteAll) {
                      ...
                      return (function ___(__then) {
                        (function ___(_) {
                          __tryCatch(_, function __$__6() {
                            return mobile.deleteSqlServer(options, resources["Microsoft.WindowsAzure.SQLAzure.Server"], __cb(_, __frame, 69, 21, __then, true));
                          });
                        })(function ___(e, __result) {
                          __catch(function __$__6() {
                            if (e) {
                    ...
                    return (function ___(__then) {
                      (function ___(_) {
                        __tryCatch(_, function __$__6() {
                          return mobile.deleteMobileServiceApplication(options, __cb(_, __frame, 87, 19, __then, true));
                        });
                      })(function ___(e, __result) {
                        __catch(function __$__6() {
                          if (e) {
  ...
  mobile.command("list").usage("[options]").description($("List your mobile services")).option("-s, --subscription <id>", $("the subscription id")).execute(function __7(options, _) {
    var progress, result;
    var __frame = {
      name: "__7",
      line: 1830
    ...
    return __func(_, this, arguments, __7, 1, __frame, function __$__7() {
      progress = cli.interaction.progress($("Getting list of mobile services"));
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$__7() {
            return mobile.listServices(options, __cb(_, __frame, 4, 28, function ___(__0, __1) {
              result = __1;
              _(null, null, true);
            }, true));
          });
  ...
  mobile.command("show [servicename]").usage("[servicename] [options]").description($("Show details for a mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __8(servicename, options, _) {
          ...
          if (results.service) {
            ...
            if (nodeFilter(results.service)) {
              if ((results.service.tables.length > 0)) {
                var tables = "";
                results.service.tables.forEach(function(table) {
                  tables += ((((tables.length > 0) ? "," : "")) + table.name);
                });
    ...
    return __func(_, this, arguments, __8, 2, __frame, function __$__8() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return ensuredServiceName(__cb(_, __frame, 3, 10, function __$__8() {
          _();
        }, true));
      }, true));
    });
  });
  mobile.command("restart [servicename]").description($("Restart a mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __9(servicename, options, _) {
    var progress, result;
    var __frame = {
      name: "__9",
      line: 1963
    ...
    return __func(_, this, arguments, __9, 2, __frame, function __$__9() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress(util.format($("Restarting mobile service: '%s'"), options.servicename));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__9() {
              return mobile.restartService(options, __cb(_, __frame, 6, 28, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  mobile.command("redeploy [servicename]").description($("Redeploy a mobile service with most recent runtime version")).option("-s, --subscription <id>", $("the subscription id")).execute(function __10(servicename, options, _) {
    var progress, result;
    var __frame = {
      name: "__10",
      line: 1984
    };
    return __func(_, this, arguments, __10, 2, __frame, function __$__10() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress(util.format($("Redeploying mobile service: '%s'"), options.servicename));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__10() {
              return mobile.redeployService(options, __cb(_, __frame, 6, 28, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  function promptKeyFields(options, servicename, type, _) {
    var __frame = {
      name: "promptKeyFields",
      line: 2007
    };
    return __func(_, this, arguments, promptKeyFields, 3, __frame, function __$promptKeyFields() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 26, function ___(__0, __1) {
        options.servicename = __1;
        return cli.interaction.chooseIfNotGiven($("Key type: "), $("Retrieving choices"), type, function(cb) {
          cb(null, keyTypes);
        }, __cb(_, __frame, 2, 35, function ___(__0, __2) {
          options.type = __2;
          if (!__.contains(keyTypes, options.type)) {
            return _(new Error($("The key type must be 'application' or 'master'.")));
          }
          ;
          _();
        }, true));
  ...
  mobileKey.command("regenerate [servicename] [type]").description($("Regenerate the mobile service key")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __11(servicename, type, options, _) {
    var result, progress;
    var __frame = {
      name: "__11",
      line: 2022
    };
    return __func(_, this, arguments, __11, 3, __frame, function __$__11() {
      return promptKeyFields(options, servicename, type, __cb(_, __frame, 1, 10, function __$__11() {
        ...
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__11() {
              return mobile.regenerateKey(options, __cb(_, __frame, 7, 28, function ___(__0, __1) {
                result = __1;
                _(null, null, true);
              }, true));
            });
  ...
  mobileKey.command("set [servicename] [type] [value]").description($("Set the mobile service key to a specific value")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __12(servicename, type, value, options, _) {
    var result, progress;
    var __frame = {
      name: "__12",
      line: 2042
    };
    return __func(_, this, arguments, __12, 4, __frame, function __$__12() {
      return promptKeyFields(options, servicename, type, __cb(_, __frame, 1, 10, function __$__12() {
        return cli.interaction.promptIfNotGiven($("Key value: "), value, __cb(_, __frame, 2, 42, function ___(__0, __1) {
          options.value = __1;
          progress = cli.interaction.progress($("Setting key"));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__12() {
                return mobile.setKey(options, {
                  Type: options.type,
                  Value: options.value
                }, __cb(_, __frame, 8, 28, function ___(__0, __2) {
                  result = __2;
                  _(null, null, true);
                }, true));
              });
  ...
  mobile.command("log [servicename]").usage("[options] [servicename]").description($("Get mobile service logs")).option("-r, --query <query>", $("log query; takes precedence over --type, --source, --continuationToken, and --top")).option("-t, --type <type>", $("filter entry by type")).option("--source <source>", $("filter entry by source")).option("-c, --continuationToken <token>", $("show logs starting from the specified continuation token")).option("-p, --top <top>", $("return the first <top> number of remaining rows")).option("-s, --subscription <id>", $("the subscription id")).execute(function __13(servicename, options, _) {
    var result, progress;
    var __frame = {
      name: "__13",
      line: 2069
    };
    return __func(_, this, arguments, __13, 2, __frame, function __$__13() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress($("Retrieving logs"));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__13() {
              return mobile.getLogs(options, __cb(_, __frame, 7, 28, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  mobileConfig.command("list [servicename]").usage("[options] [servicename]").description($("Show your mobile service configuration settings")).option("-s, --subscription <id>", $("the subscription id")).execute(function __14(servicename, options, _) {
    ...
    return __func(_, this, arguments, __14, 2, __frame, function __$__14() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress($("Getting mobile service configuration"));
        results = {
        };
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__14() {
              return mobile.getServiceSettings(options, __cb(_, __frame, 7, 37, function ___(__0, __2) {
                results.service = __2;
                return mobile.getAuthSettings(options, __cb(_, __frame, 8, 34, function ___(__0, __3) {
                  results.auth = __3;
                  return mobile.getApnsSettings(options, __cb(_, __frame, 9, 34, function ___(__0, __4) {
                    results.apns = __4;
                    return mobile.getPushSettings(options, __cb(_, __frame, 10, 33, function ___(__0, __5) {
                      results.gcm = __5;
                      results.live = (__.find(results.auth, function(authSettings) {
                        return (authSettings.provider === "microsoft");
                      }) || {
                      });
                      results.auth = __.reject(results.auth, function(authSettings) {
                        return (authSettings.provider === "microsoft");
                      });
  ...
  mobileConfig.command("get [servicename] [key]").usage("[options] [servicename] [key]").description($("Get a mobile service configuration setting")).option("-f, --file <file>", $("save the value of the setting to a file")).option("-s, --subscription <id>", $("the subscription id")).execute(function __15(servicename, key, options, _) {
    var i, result, progress, value;
    var __frame = {
      name: "__15",
      line: 2442
    };
    return __func(_, this, arguments, __15, 3, __frame, function __$__15() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return cli.interaction.chooseIfNotGiven($("Setting key: "), $("Getting choices"), key, function(cb) {
          cb(null, __.keys(getConfigHandlers));
        }, __cb(_, __frame, 2, 32, function ___(__0, __2) {
          key = __2;
          ...
          ;
          progress = cli.interaction.progress(util.format($("Retrieving setting: %s"), key));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__15() {
                return getConfigHandlers[key](options, __cb(_, __frame, 19, 21, function ___(__0, __3) {
                  result = __3;
                  _(null, null, true);
                }, true));
              });
  ...
  mobileDomain.command("list [servicename]").usage("[options] [servicename]").description($("List domains for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __16(servicename, options, _) {
    var progress;
    var __frame = {
      name: "__16",
      line: 2494
    ...
    return __func(_, this, arguments, __16, 2, __frame, function __$__16() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress(util.format($("Listing domains for %s mobile service"), options.servicename));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__16() {
              return mobile.getDomains(options, __cb(_, __frame, 5, 26, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  mobileDomain.command("add [servicename] [domain]").usage("[options] [servicename] [domain]").description($("Add domain to mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __17(servicename, domain, options, _) {
    var progress;
    var __frame = {
      name: "__17",
      line: 2515
    };
    return __func(_, this, arguments, __17, 3, __frame, function __$__17() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("Domain: "), domain, __cb(_, __frame, 3, 17, function ___(__0, __2) {
          domain = __2;
          progress = cli.interaction.progress(util.format($("Adding %s domain to %s mobile service"), domain, options.servicename));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__17() {
                return (function ___(__then) {
                  (function ___(_) {
                    __tryCatch(_, function __$__17() {
                      return mobile.addDomain(options, domain, __cb(_, __frame, 7, 26, function ___(__0, __3) {
                        result = __3;
                        __then();
                      }, true));
                    });
                  })(function ___(exception, __result) {
                    __catch(function __$__17() {
                      if (exception) {
                        log.error("Ensure that you have a cname record associating the new domain with your .azure-mobile.net domain");
                        return _(exception);
                      }
                       else {
                        _(null, __result);
  ...
  mobileDomain.command("delete [servicename] [domain]").usage("[options] [servicename]").description($("Delete domain from mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __18(servicename, domain, options, _) {
    var progress;
    var __frame = {
      name: "__18",
      line: 2535
    };
    return __func(_, this, arguments, __18, 3, __frame, function __$__18() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptDomainIfNotGiven(options, domain, __cb(_, __frame, 3, 17, function ___(__0, __2) {
          domain = __2;
          progress = cli.interaction.progress(util.format($("Deleting %s domain from %s mobile service"), domain, options.servicename));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__18() {
                return mobile.deleteDomain(options, domain, __cb(_, __frame, 7, 26, function ___(__0, __3) {
                  result = __3;
                  _(null, null, true);
                }, true));
              });
  ...
  mobileDomainSsl.command("show [servicename] [domain]").usage("[options] [servicename] [domain]").description($("Show SSL state for domain")).option("-s, --subscription <id>", $("the subscription id")).execute(function __19(servicename, domain, options, _) {
    var progress;
    var __frame = {
      name: "__19",
      line: 2555
    };
    return __func(_, this, arguments, __19, 3, __frame, function __$__19() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptDomainIfNotGiven(options, domain, __cb(_, __frame, 3, 17, function ___(__0, __2) {
          domain = __2;
          progress = cli.interaction.progress(util.format($("Show SSL state for %s domain from %s mobile service"), domain, options.servicename));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__19() {
                return mobile.getSslState(options, domain, __cb(_, __frame, 7, 26, function ___(__0, __3) {
                  result = __3;
                  _(null, null, true);
                }, true));
              });
  ...
  mobileDomainSsl.command("enable [servicename] [domain] [thumbprint]").usage("[options] [servicename] [domain] [thumbprint]").description($("Enable SSL for domain by attaching an SSL Certificate.  To add SSL Certificates use the \"azure mobile cert add\" command")).option("-s, --subscription <id>", $("the subscription id")).execute(function __20(servicename, domain, thumbprint, options, _) {
    var progress;
    var __frame = {
      name: "__20",
      line: 2581
    };
    return __func(_, this, arguments, __20, 4, __frame, function __$__20() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptDomainIfNotGiven(options, domain, __cb(_, __frame, 2, 17, function ___(__0, __2) {
          domain = __2;
          return promptThumbprintIfNotGiven(options, thumbprint, __cb(_, __frame, 3, 21, function ___(__0, __3) {
            thumbprint = __3.toUpperCase();
            progress = cli.interaction.progress(util.format($("Enabling SSL for %s domain using certificate with thumbprint %s for %s mobile service"), domain, thumbprint, options.servicename));
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$__20() {
                  return (function ___(__then) {
                    (function ___(_) {
                      __tryCatch(_, function __$__20() {
                        return mobile.enableSsl(options, domain, thumbprint, __cb(_, __frame, 7, 26, function ___(__0, __4) {
                          result = __4;
                          __then();
                        }, true));
                      });
                    })(function ___(exception, __result) {
                      __catch(function __$__20() {
                        if (exception) {
                          log.error("Ensure that the subject of the certificate matches the domain for which you wish to use SSL");
                          return _(exception);
                        }
                         else {
                          _(null, __result);
  ...
  mobileDomainSsl.command("disable [servicename] [domain] [thumbprint]").usage("[options] [servicename] [domain] [thumbprint]").description($("Disable SSL for domain by detaching SSL Certificate.")).option("-s, --subscription <id>", $("the subscription id")).execute(function __21(servicename, domain, thumbprint, options, _) {
    var progress;
    var __frame = {
      name: "__21",
      line: 2601
    };
    return __func(_, this, arguments, __21, 4, __frame, function __$__21() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptDomainIfNotGiven(options, domain, __cb(_, __frame, 2, 17, function ___(__0, __2) {
          domain = __2;
          return promptThumbprintIfNotGiven(options, thumbprint, __cb(_, __frame, 3, 21, function ___(__0, __3) {
            thumbprint = __3.toUpperCase();
            progress = cli.interaction.progress(util.format($("Disabling SSL for %s domain using certificate with thumbprint %s for %s mobile service"), domain, thumbprint, options.servicename));
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$__21() {
                  return mobile.disableSsl(options, domain, thumbprint, __cb(_, __frame, 7, 26, function ___(__0, __4) {
                    result = __4;
                    _(null, null, true);
                  }, true));
                });
  ...
  mobileCert.command("list [servicename]").usage("[options] [servicename]").description($("List certificates for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __22(servicename, options, _) {
    var progress;
    var __frame = {
      name: "__22",
      line: 2621
    ...
    return __func(_, this, arguments, __22, 2, __frame, function __$__22() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress(util.format($("Listing certificates for %s mobile service"), options.servicename));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__22() {
              return mobile.getCertificates(options, __cb(_, __frame, 5, 26, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  mobileCert.command("add [servicename] [certificate-path] [key]").usage("[options] [servicename] [certificate-path] [key]").description($("Add certificate to mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __23(servicename, certificatePath, key, options, _) {
    var progress, certificateContent, cert;
    var __frame = {
      name: "__23",
      line: 2647
    };
    return __func(_, this, arguments, __23, 4, __frame, function __$__23() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return cli.interaction.promptIfNotGiven($("Certificate path: "), certificatePath, __cb(_, __frame, 3, 42, function ___(__0, __2) {
          certificatePath = __2;
          ...
          ;
          return promptIfNotGiven($("Certificate key: "), key, __cb(_, __frame, 13, 14, function ___(__0, __3) {
            key = __3;
            progress = cli.interaction.progress(util.format($("Adding certificate with path %s for %s mobile service"), certificatePath, options.servicename));
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$__23() {
                  return (function ___(__then) {
                    (function ___(_) {
                      __tryCatch(_, function __$__23() {
                        return fs.readFile(certificatePath, __cb(_, __frame, 17, 38, function ___(__0, __4) {
                          certificateContent = __4;
                          cert = {
                            PfxBlob: certificateContent.toString("base64"),
                            Password: key
                          };
                          return mobile.addCertificate(options, cert, __cb(_, __frame, 22, 26, function ___(__0, __5) {
                            result = __5;
                            __then();
                          }, true));
                        }, true));
  ...
  mobileCert.command("delete [servicename] [thumbprint]").usage("[options] [servicename] [thumbprint]").description($("Delete certificate from mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __24(servicename, thumbprint, options, _) {
    var progress;
    var __frame = {
      name: "__24",
      line: 2682
    };
    return __func(_, this, arguments, __24, 3, __frame, function __$__24() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptThumbprintIfNotGiven(options, thumbprint, __cb(_, __frame, 3, 21, function ___(__0, __2) {
          thumbprint = __2.toUpperCase();
          progress = cli.interaction.progress(util.format($("Deleting certificate with %s thumbprint for %s mobile service"), thumbprint, options.servicename));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__24() {
                return mobile.deleteCertificate(options, thumbprint, __cb(_, __frame, 7, 26, function ___(__0, __3) {
                  result = __3;
                  _(null, null, true);
                }, true));
              });
  ...
  mobilePushNh.command("get [servicename]").usage("[options] [servicename]").description($("Get notification hub settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __25(servicename, options, _) {
    var progress;
    var __frame = {
      name: "__25",
      line: 2705
    };
    return __func(_, this, arguments, __25, 2, __frame, function __$__25() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress($("Getting notification hub settings for mobile service"));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__25() {
              return mobile.getPushEntity(options, __cb(_, __frame, 5, 26, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  mobilePushNh.command("enable [servicename]").usage("[options] [servicename]").description($("Create notification hub for mobile service")).option("-s, --subscription <id>", $("the subscription id")).option("--nowait", $("Do not wait for push operation to complete")).execute(function __26(servicename, options, _) {
    var progress, settings;
    var __frame = {
      name: "__26",
      line: 2733
    };
    return __func(_, this, arguments, __26, 2, __frame, function __$__26() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        ...
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__26() {
              return mobile.getPushEntity(options, __cb(_, __frame, 10, 26, function ___(__0, __2) {
                result = __2;
                ...
                ;
                return mobile.setPushEntity(options, settings, __cb(_, __frame, 16, 17, function __$__26() {
                  return (function __$__26(__then) {
                    if (!options.nowait) {
                      return mobile.waitForPushEnabling(options, __cb(_, __frame, 18, 19, __then, true));
                    }
                     else {
                      __then();
                    }
  ...
  mobilePushNh.command("disable [servicename]").usage("[options] [servicename]").description($("Create notification hub for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __27(servicename, options, _) {
    var progress, settings;
    var __frame = {
      name: "__27",
      line: 2762
    };
    return __func(_, this, arguments, __27, 2, __frame, function __$__27() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 28, function ___(__0, __1) {
        options.servicename = __1;
        ...
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__27() {
              return mobile.setPushEntity(options, settings, __cb(_, __frame, 9, 17, function __$__27() {
                _(null, null, true);
              }, true));
            });
          })(function ___(__e, __r, __cont) {
  ...
  function getPushSettings(options, progressInfo, settingsName, resultFormatter, _) {
    ...
    return __func(_, this, arguments, getPushSettings, 4, __frame, function __$getPushSettings() {
      progress = cli.interaction.progress(util.format($("Getting %s settings for %s mobile service"), progressInfo, options.servicename));
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$getPushSettings() {
            return mobile.getPushSettings(options, __cb(_, __frame, 4, 22, function ___(__0, __1) {
              result = __1;
              _(null, null, true);
            }, true));
          });
  ...
  function setPushSettings(options, progressInfo, settings, _) {
    ...
    return __func(_, this, arguments, setPushSettings, 3, __frame, function __$setPushSettings() {
      progress = cli.interaction.progress(util.format($("Setting %s settings for %s mobile service"), progressInfo, options.servicename));
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$setPushSettings() {
            return mobile.patchPushSettings(options, settings, __cb(_, __frame, 3, 13, function __$setPushSettings() {
              _(null, null, true);
            }, true));
          });
        })(function ___(__e, __r, __cont) {
  ...
  function deletePushSettings(options, progressInfo, settings, _) {
    var progress;
    var __frame = {
      name: "deletePushSettings",
      line: 2806
    };
    return __func(_, this, arguments, deletePushSettings, 3, __frame, function __$deletePushSettings() {
      progress = cli.interaction.progress(util.format($("Deleting %s settings for %s mobile service"), progressInfo, options.servicename));
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$deletePushSettings() {
            return mobile.patchPushSettings(options, settings, __cb(_, __frame, 3, 13, function __$deletePushSettings() {
              _(null, null, true);
            }, true));
          });
        })(function ___(__e, __r, __cont) {
  ...
  mobilePushGcm.command("get [servicename]").usage("[options] [servicename]").description($("Get google cloud API key for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __28(servicename, options, _) {
    var __frame = {
      name: "__28",
      line: 2822
    };
    return __func(_, this, arguments, __28, 2, __frame, function __$__28() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return getPushSettings(options, $("GCM"), "gcmCredentials", function(result) {
          log.data($("API Key"), setColorOrDefault(result.apiKey));
        }, __cb(_, __frame, 3, 8, function __$__28() {
          _();
        }, true));
      }, true));
    });
  });
  mobilePushGcm.command("set [servicename] [apiKey]").usage("[options] [servicename] [apiKey]").description($("Set google cloud API key for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __29(servicename, apiKey, options, _) {
    var settings;
    var __frame = {
      name: "__29",
      line: 2834
    };
    return __func(_, this, arguments, __29, 3, __frame, function __$__29() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven("API Key", apiKey, __cb(_, __frame, 2, 25, function ___(__0, __2) {
          options.apiKey = __2;
          settings = {
            gcmCredentials: {
          ...
          return setPushSettings(options, $("GCM"), settings, __cb(_, __frame, 11, 8, function __$__29() {
            _();
          }, true));
        }, true));
      }, true));
  ...
  mobilePushGcm.command("delete [servicename]").usage("[options] [servicename]").description($("Delete google cloud API key for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __30(servicename, options, _) {
    var settings;
    var __frame = {
      name: "__30",
      line: 2852
    };
    return __func(_, this, arguments, __30, 2, __frame, function __$__30() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        settings = {
          gcmCredentials: {
        ...
        return deletePushSettings(options, $("GCM"), settings, __cb(_, __frame, 8, 8, function __$__30() {
          _();
        }, true));
      }, true));
    });
  ...
  mobilePushApns.command("get [servicename]").usage("[options] [servicename]").description($("Get Apple push notification settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).option("-f, --file <file>", $("save the certificate to file")).execute(function __31(servicename, options, _) {
    var __frame = {
      name: "__31",
      line: 2871
    };
    return __func(_, this, arguments, __31, 2, __frame, function __$__31() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return getPushSettings(options, $("APNS"), "apnsCredentials", function(result) {
          ...
          ;
        }, __cb(_, __frame, 3, 8, function __$__31() {
          _();
        }, true));
      }, true));
    });
  });
  mobilePushApns.command("set [servicename] [mode] [certificateFile]").usage("[options] [servicename] [mode] [certificateFile]").description($("Set Apple push notification settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).option("-p, --password <password>", $("password for certificateFile")).execute(function __32(servicename, mode, certificateFile, password, options, _) {
    var settings;
    var __frame = {
      name: "__32",
      line: 2897
    };
    return __func(_, this, arguments, __32, 5, __frame, function __$__32() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("Mode"), mode, __cb(_, __frame, 2, 23, function ___(__0, __2) {
          options.mode = __2;
          ...
          ;
          return promptIfNotGiven($("Certificate File"), certificateFile, __cb(_, __frame, 13, 34, function ___(__0, __3) {
            options.certificateFile = __3;
            ...
            return setPushSettings(options, $("APNS"), settings, __cb(_, __frame, 24, 8, function __$__32() {
              _();
            }, true));
          }, true));
        }, true));
  ...
  mobilePushApns.command("delete [servicename]").usage("[options] [servicename]").description($("Delete Apple push notification settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __33(servicename, options, _) {
    var settings;
    var __frame = {
      name: "__33",
      line: 2928
    };
    return __func(_, this, arguments, __33, 2, __frame, function __$__33() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        settings = {
          apnsCredentials: {
        ...
        return deletePushSettings(options, $("APNS"), settings, __cb(_, __frame, 8, 8, function __$__33() {
          _();
        }, true));
      }, true));
    });
  ...
  mobilePushMpns.command("get [servicename]").usage("[options] [servicename]").description($("Get windows phone notification settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).option("-f, --file <file>", $("save the certificate to file")).execute(function __34(servicename, options, _) {
    var __frame = {
      name: "__34",
      line: 2947
    };
    return __func(_, this, arguments, __34, 2, __frame, function __$__34() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return getPushSettings(options, $("windows phone notification"), "mpnsCredentials", function(result) {
          ...
          ;
        }, __cb(_, __frame, 3, 8, function __$__34() {
          _();
        }, true));
      }, true));
    });
  });
  mobilePushMpns.command("set [servicename] [certificateFile] [password]").usage("[options] [servicename] [certificateFile] [password]").description($("Set windows phone notification settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __35(servicename, certificateFile, password, options, _) {
    var settings;
    var __frame = {
      name: "__35",
      line: 2972
    };
    return __func(_, this, arguments, __35, 4, __frame, function __$__35() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("Certificate File"), certificateFile, __cb(_, __frame, 4, 34, function ___(__0, __2) {
          options.certificateFile = __2;
          options.certificateData = fs.readFileSync(options.certificateFile, "base64");
          return promptIfNotGiven($("Certificate Password"), password, __cb(_, __frame, 6, 27, function ___(__0, __3) {
            options.password = __3;
            settings = {
              mpnsCredentials: {
            ...
            return setPushSettings(options, $("windows phone notification"), settings, __cb(_, __frame, 16, 8, function __$__35() {
              _();
            }, true));
          }, true));
        }, true));
  ...
  mobilePushMpns.command("delete [servicename]").usage("[options] [servicename]").description($("Delete windows phone notification settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __36(servicename, options, _) {
    var settings;
    var __frame = {
      name: "__36",
      line: 2995
    };
    return __func(_, this, arguments, __36, 2, __frame, function __$__36() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        settings = {
          mpnsCredentials: {
        ...
        return deletePushSettings(options, $("windows phone notification"), settings, __cb(_, __frame, 9, 8, function __$__36() {
          _();
        }, true));
      }, true));
    });
  ...
  mobilePushWns.command("get [servicename]").usage("[options] [servicename]").description($("Get windows application credentials for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __37(servicename, options, _) {
    var __frame = {
      name: "__37",
      line: 3014
    };
    return __func(_, this, arguments, __37, 2, __frame, function __$__37() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        ...
        }, __cb(_, __frame, 3, 8, function __$__37() {
          _();
        }, true));
      }, true));
    });
  });
  mobilePushWns.command("set [servicename] [clientSecret] [packageSID]").usage("[options] [servicename] [clientSecret] [packageSID]").description($("Set windows application credentials for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __38(servicename, clientSecret, packageSID, options, _) {
    var settings;
    var __frame = {
      name: "__38",
      line: 3027
    };
    return __func(_, this, arguments, __38, 4, __frame, function __$__38() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("Client Secret"), clientSecret, __cb(_, __frame, 2, 31, function ___(__0, __2) {
          options.clientSecret = __2;
          return promptIfNotGiven($("Package SID"), packageSID, __cb(_, __frame, 3, 29, function ___(__0, __3) {
            options.packageSID = __3;
            settings = {
              wnsCredentials: {
            ...
            return setPushSettings(options, $("windows application credential"), settings, __cb(_, __frame, 12, 8, function __$__38() {
              _();
            }, true));
          }, true));
        }, true));
  ...
  mobilePushWns.command("delete [servicename]").usage("[options] [servicename]").description($("Delete windows application credentials for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __39(servicename, options, _) {
    var settings;
    var __frame = {
      name: "__39",
      line: 3046
    };
    return __func(_, this, arguments, __39, 2, __frame, function __$__39() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        settings = {
          wnsCredentials: {
        ...
        return deletePushSettings(options, $("windows application credentials"), settings, __cb(_, __frame, 7, 8, function __$__39() {
          _();
        }, true));
      }, true));
    });
  ...
  function getAuthSettingAndOutput(options, progressInfo, authType, resultHandler, _) {
    var result, progress, settingsForAuthType;
    var __frame = {
      name: "getAuthSettingAndOutput",
      line: 3059
    };
    return __func(_, this, arguments, getAuthSettingAndOutput, 4, __frame, function __$getAuthSettingAndOutput() {
      progress = cli.interaction.progress(util.format($("Getting %s settings for %s mobile service"), progressInfo, options.servicename));
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$getAuthSettingAndOutput() {
            return mobile.getAuthSettings(options, __cb(_, __frame, 4, 22, function ___(__0, __1) {
              result = __1;
              _(null, null, true);
            }, true));
          });
        ...
        __tryCatch(_, function __$getAuthSettingAndOutput() {
          settingsForAuthType = (__.find(result, function(authSettings) {
            return (authSettings.provider === authType);
          }) || {
          });
  ...
  function setAuthSettingsCore(options, progressInfo, authType, newAuthSettings, _) {
    var progress, result;
    var __frame = {
      name: "setAuthSettingsCore",
      line: 3073
    };
    return __func(_, this, arguments, setAuthSettingsCore, 4, __frame, function __$setAuthSettingsCore() {
      progress = cli.interaction.progress(util.format($("Setting %s settings for %s mobile service"), progressInfo, options.servicename));
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$setAuthSettingsCore() {
            return mobile.getAuthSettings(options, __cb(_, __frame, 3, 26, function ___(__0, __1) {
              result = __1;
              result = __.reject(result, function(authSettings) {
                return (authSettings.provider == authType);
              });
              result.push(newAuthSettings);
              return mobile.setAuthSettings(options, result, __cb(_, __frame, 8, 13, function __$setAuthSettingsCore() {
                _(null, null, true);
              }, true));
            }, true));
          });
  ...
  function deleteAuthSettingsCore(options, progressInfo, authType, _) {
    var progress, result;
    var __frame = {
      name: "deleteAuthSettingsCore",
      line: 3087
    };
    return __func(_, this, arguments, deleteAuthSettingsCore, 3, __frame, function __$deleteAuthSettingsCore() {
      progress = cli.interaction.progress(util.format($("Deleting %s settings for %s mobile service"), progressInfo, options.servicename));
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$deleteAuthSettingsCore() {
            return mobile.getAuthSettings(options, __cb(_, __frame, 3, 26, function ___(__0, __1) {
              result = __1;
              return mobile.setAuthSettings(options, __.reject(result, function(authSettings) {
                return (authSettings.provider === authType);
              }), __cb(_, __frame, 4, 13, function __$deleteAuthSettingsCore() {
                _(null, null, true);
              }, true));
            }, true));
          });
  ...
  mobileAuthMicrosoft.command("get [servicename]").usage("[options] [servicename]").description($("Get microsoft account settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __40(servicename, options, _) {
    var __frame = {
      name: "__40",
      line: 3104
    };
    return __func(_, this, arguments, __40, 2, __frame, function __$__40() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        ...
        }, __cb(_, __frame, 3, 8, function __$__40() {
          _();
        }, true));
      }, true));
    });
  });
  mobileAuthMicrosoft.command("set [servicename] [clientId] [clientSecret]").usage("[options] [servicename] [clientId] [clientSecret]").description($("Set microsoft account settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).option("--packageSid <packageSid>", $("Package SID to be set")).execute(function __41(servicename, clientId, clientSecret, options, _) {
    var progress, result, existingSettings, updatedSettings;
    var __frame = {
      name: "__41",
      line: 3119
    };
    return __func(_, this, arguments, __41, 4, __frame, function __$__41() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return (function __$__41(__then) {
          if (!options.packageSid) {
            return promptIfNotGiven($("ClientId"), clientId, __cb(_, __frame, 4, 29, function ___(__0, __2) {
              options.clientId = __2;
              return promptIfNotGiven($("ClientSecret"), clientSecret, __cb(_, __frame, 5, 33, function ___(__0, __3) {
                options.clientSecret = __3;
                __then();
              }, true));
            }, true));
          }
          ...
          progress = cli.interaction.progress(util.format($("Setting microsoft account settings for %s mobile service"), options.servicename));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__41() {
                return mobile.getAuthSettings(options, __cb(_, __frame, 10, 30, function ___(__0, __4) {
                  result = __4;
                  existingSettings = __.find(result, function(authSettings) {
                    return (authSettings.provider === "microsoft");
                  });
                  if (existingSettings) {
                    result = __.reject(result, function(authSettings) {
                  ...
                  return mobile.setAuthSettings(options, result, __cb(_, __frame, 28, 17, function __$__41() {
                    _(null, null, true);
                  }, true));
                }, true));
              });
  ...
  mobileAuthMicrosoft.command("delete [servicename]").usage("[options] [servicename]").description($("Delete microsoft account settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __42(servicename, options, _) {
    var __frame = {
      name: "__42",
      line: 3157
    };
    return __func(_, this, arguments, __42, 2, __frame, function __$__42() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return deleteAuthSettingsCore(options, $("microsoft account"), "microsoft", __cb(_, __frame, 3, 8, function __$__42() {
          _();
        }, true));
      }, true));
    });
  ...
  mobileAuthFacebook.command("get [servicename]").usage("[options] [servicename]").description($("Get facebook identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __43(servicename, options, _) {
    var __frame = {
      name: "__43",
      line: 3170
    };
    return __func(_, this, arguments, __43, 2, __frame, function __$__43() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        ...
        }, __cb(_, __frame, 3, 8, function __$__43() {
          _();
        }, true));
      }, true));
    });
  });
  mobileAuthFacebook.command("set [servicename] [apiKey] [appSecret]").usage("[options] [servicename] [apiKey] [appSecret]").description($("Set facebook identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __44(servicename, apiKey, appSecret, options, _) {
    var authSettings;
    var __frame = {
      name: "__44",
      line: 3183
    ...
    return __func(_, this, arguments, __44, 4, __frame, function __$__44() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        ...
        return promptIfNotGiven($("API Key"), apiKey, __cb(_, __frame, 2, 25, function ___(__0, __2) {
          options.apiKey = __2;
          return promptIfNotGiven($("App Secret"), appSecret, __cb(_, __frame, 3, 28, function ___(__0, __3) {
            options.appSecret = __3;
            authSettings = {
              provider: "facebook",
              appId: options.apiKey,
              secret: options.appSecret
            };
            return setAuthSettingsCore(options, $("facebook"), "facebook", authSettings, __cb(_, __frame, 11, 8, function __$__44() {
              _();
            }, true));
          }, true));
        }, true));
  ...
  mobileAuthFacebook.command("delete [servicename]").usage("[options] [servicename]").description($("Delete facebook identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __45(servicename, options, _) {
    var __frame = {
      name: "__45",
      line: 3201
    };
    return __func(_, this, arguments, __45, 2, __frame, function __$__45() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return deleteAuthSettingsCore(options, $("facebook"), "facebook", __cb(_, __frame, 3, 8, function __$__45() {
          _();
        }, true));
      }, true));
    });
  ...
  mobileAuthTwitter.command("get [servicename]").usage("[options] [servicename]").description($("Get twitter identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __46(servicename, options, _) {
    var __frame = {
      name: "__46",
      line: 3214
    };
    return __func(_, this, arguments, __46, 2, __frame, function __$__46() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        ...
        }, __cb(_, __frame, 3, 8, function __$__46() {
          _();
        }, true));
      }, true));
    });
  });
  mobileAuthTwitter.command("set [servicename] [apiKey] [apiSecret]").usage("[options] [servicename] [apiKey] [apiSecret]").description($("Set twitter identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __47(servicename, apiKey, apiSecret, options, _) {
    var authSettings;
    var __frame = {
      name: "__47",
      line: 3227
    };
    return __func(_, this, arguments, __47, 4, __frame, function __$__47() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("ClientId"), apiKey, __cb(_, __frame, 2, 25, function ___(__0, __2) {
          options.apiKey = __2;
          return promptIfNotGiven($("ClientSecret"), apiSecret, __cb(_, __frame, 3, 28, function ___(__0, __3) {
            options.apiSecret = __3;
            authSettings = {
              provider: "twitter",
              appId: options.apiKey,
              secret: options.apiSecret
            };
            return setAuthSettingsCore(options, $("twitter"), "twitter", authSettings, __cb(_, __frame, 11, 8, function __$__47() {
              _();
            }, true));
          }, true));
        }, true));
  ...
  mobileAuthTwitter.command("delete [servicename]").usage("[options] [servicename]").description($("Delete twitter identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __48(servicename, options, _) {
    var __frame = {
      name: "__48",
      line: 3245
    };
    return __func(_, this, arguments, __48, 2, __frame, function __$__48() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return deleteAuthSettingsCore(options, $("twitter"), "twitter", __cb(_, __frame, 3, 8, function __$__48() {
          _();
        }, true));
      }, true));
    });
  ...
  mobileAuthGoogle.command("get [servicename]").usage("[options] [servicename]").description($("Get google identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __49(servicename, options, _) {
    var __frame = {
      name: "__49",
      line: 3258
    };
    return __func(_, this, arguments, __49, 2, __frame, function __$__49() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return getAuthSettingAndOutput(options, $("google"), "google", function(output) {
          log.data($("Client Id"), setColorOrDefault(output.appId));
          log.data($("Client Secret"), setColorOrDefault(output.secret));
        }, __cb(_, __frame, 3, 8, function __$__49() {
          _();
        }, true));
      }, true));
    });
  });
  mobileAuthGoogle.command("set [servicename] [clientId] [clientSecret]").usage("[options] [servicename] [clientId] [clientSecret]").description($("Set google identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __50(servicename, clientId, clientSecret, options, _) {
    var authSettings;
    var __frame = {
      name: "__50",
      line: 3271
    };
    return __func(_, this, arguments, __50, 4, __frame, function __$__50() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("ClientId"), clientId, __cb(_, __frame, 2, 27, function ___(__0, __2) {
          options.clientId = __2;
          return promptIfNotGiven($("ClientSecret"), clientSecret, __cb(_, __frame, 3, 31, function ___(__0, __3) {
            options.clientSecret = __3;
            authSettings = {
              provider: "google",
            ...
            return setAuthSettingsCore(options, $("google"), "google", authSettings, __cb(_, __frame, 11, 8, function __$__50() {
              _();
            }, true));
          }, true));
        }, true));
  ...
  mobileAuthGoogle.command("delete [servicename]").usage("[options] [servicename]").description($("Delete google identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __51(servicename, options, _) {
    var __frame = {
      name: "__51",
      line: 3289
    };
    return __func(_, this, arguments, __51, 2, __frame, function __$__51() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return deleteAuthSettingsCore(options, $("google"), "google", __cb(_, __frame, 3, 8, function __$__51() {
          _();
        }, true));
      }, true));
    });
  ...
  mobileAuthAad.command("get [servicename]").usage("[options] [servicename]").description($("Get azure active directory identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __52(servicename, options, _) {
    var __frame = {
      name: "__52",
      line: 3302
    };
    return __func(_, this, arguments, __52, 2, __frame, function __$__52() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return getAuthSettingAndOutput(options, $("AAD"), "aad", function(output) {
          log.data($("Client Id"), setColorOrDefault(output.appId));
        }, __cb(_, __frame, 3, 8, function __$__52() {
          _();
        }, true));
      }, true));
    });
  });
  mobileAuthAad.command("set [servicename] [clientId]").usage("[options] [servicename] [clientId]").description($("Set azure active directory identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __53(servicename, clientId, options, _) {
    var authSettings;
    var __frame = {
      name: "__53",
      line: 3314
    };
    return __func(_, this, arguments, __53, 3, __frame, function __$__53() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("ClientId"), clientId, __cb(_, __frame, 2, 27, function ___(__0, __2) {
          options.clientId = __2;
          ...
          return setAuthSettingsCore(options, $("AAD"), "aad", authSettings, __cb(_, __frame, 11, 8, function __$__53() {
            _();
          }, true));
        }, true));
      }, true));
  ...
  mobileAuthAad.command("delete [servicename]").usage("[options] [servicename]").description($("Delete azure active directory identity settings for mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __54(servicename, options, _) {
    var __frame = {
      name: "__54",
      line: 3332
    };
    return __func(_, this, arguments, __54, 2, __frame, function __$__54() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 30, function ___(__0, __1) {
        options.servicename = __1;
        return deleteAuthSettingsCore(options, $("AAD"), "aad", __cb(_, __frame, 3, 8, function __$__54() {
          _();
        }, true));
      }, true));
    });
  ...
  mobileTable.command("list [servicename]").usage("[options] [servicename]").description($("List mobile service tables")).option("-s, --subscription <id>", $("the subscription id")).execute(function __55(servicename, options, _) {
    var result, progress;
    var __frame = {
      name: "__55",
      line: 3345
    };
    return __func(_, this, arguments, __55, 2, __frame, function __$__55() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress($("Getting table information"));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__55() {
              return mobile.listTables(options, __cb(_, __frame, 7, 28, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  mobileTable.command("show [servicename] [tablename]").usage("[options] [servicename] [tablename]").description($("Show details for a mobile service table")).option("-s, --subscription <id>", $("the subscription id")).execute(function __56(servicename, tablename, options, _) {
    var result, progress;
    var __frame = {
      name: "__56",
      line: 3407
    };
    return __func(_, this, arguments, __56, 3, __frame, function __$__56() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptTableNameIfNotGiven(options, tablename, __cb(_, __frame, 2, 30, function ___(__0, __2) {
          options.tablename = __2;
          progress = cli.interaction.progress($("Getting table information"));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__56() {
                return loadTableMetaData(options, __cb(_, __frame, 8, 21, function ___(__0, __3) {
                  result = __3;
                  _(null, null, true);
                }, true));
              });
  ...
  function parsePermissions(permissions, keys) {
    ...
    if (__.isString(permissions)) {
      ...
      permissions.split(",").forEach(function(pair) {
        ...
        ;
        if (((match[1] !== "*") && !keys.some(function(key) {
          return (key === match[1]);
        }))) {
    ...
    return __func(_, this, arguments, __57, 3, __frame, function __$__57() {
      return (function ___(__then) {
        ...
        __tryCatch(_, function __$__57() {
          ...
          return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 20, 32, function ___(__0, __1) {
            options.servicename = __1;
            return promptIfNotGiven($("Table name: "), tablename, __cb(_, __frame, 21, 26, function ___(__0, __2) {
              settings.name = __2;
              ...
              ;
              progress = cli.interaction.progress($("Creating table"));
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$__57() {
                    return mobile.createTable(options, settings, __cb(_, __frame, 31, 19, function __$__57() {
                      _(null, null, true);
                    }, true));
                  });
                })(function ___(__e, __r, __cont) {
  ...
  mobileTable.command("update [servicename] [tablename]").usage("[options] [servicename] [tablename]").description($("Update mobile service table properties")).option("-p, --permissions <permissions>", $("comma delimited list of <operation>=<permission> pairs")).option("--addColumn <columns>", $("comma separated list of <name>=<type> to add")).option("--deleteColumn <columns>", $("comma separated list of columns to delete")).option("-q, --quiet", $("do not prompt for confirmation of column deletion")).option("--addIndex <columns>", $("comma separated list of columns to create an index on")).option("--deleteIndex <columns>", $("comma separated list of columns to delete an index from")).option("-s, --subscription <id>", $("the subscription id")).execute(function __58(servicename, tablename, options, _) {
    ...
    return __func(_, this, arguments, __58, 3, __frame, function __$__58() {
      ...
      return (function ___(__then) {
        ...
        __tryCatch(_, function __$__58() {
          return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 15, 32, function ___(__0, __1) {
            options.servicename = __1;
            return promptTableNameIfNotGiven(options, tablename, __cb(_, __frame, 16, 30, function ___(__0, __2) {
              options.tablename = __2;
              return (function __$__58(__then) {
                if ((__.isString(options.deleteColumn) && !options.quiet)) {
                  return cli.interaction.confirm($("Do you really want to delete the column(s)? [y/n]: "), __cb(_, __frame, 19, 32, function ___(__0, __4) {
                    var __3 = (__4 === false);
                    return (function __$__58(__then) {
                      if (__3) {
                ...
                if (options.addColumn) {
                  options.addColumn.split(",").forEach(function(columnPair) {
                    ...
                    plan.push({
                      ...
                      handler: function(callback) {
                        mobile.addColumn(options, columnInfo[0], {
                          type: columnInfo[1]
                        }, callback);
                      }
                    });
                ...
                return (function ___(__break) {
                  var __more;
                  var __loop = __cb(_, __frame, 0, 0, function __$__58() {
                    __more = false;
                    if (__9) {
                      i++;
                    }
                        ...
                        (function ___(_) {
                          __tryCatch(_, function __$__58() {
                            return (function ___(__then) {
                              (function ___(_) {
                                __tryCatch(_, function __$__58() {
                                  return step.handler(__cb(_, __frame, 109, 19, function __$__58() {
                  ...
                  if ((failures !== 0)) {
                    return _(new Error($("Not all update operations completed successfully")));
                  }
                  ;
                  _();
                });
  ...
  mobileTable.command("delete [servicename] [tablename]").usage("[options] [servicename] [tablename]").description($("Delete a mobile service table")).option("-q, --quiet", $("do not prompt for confirmation")).option("-s, --subscription <id>", $("the subscription id")).execute(function __59(servicename, tablename, options, _) {
    var progress;
    var __frame = {
      name: "__59",
      line: 3680
    };
    return __func(_, this, arguments, __59, 3, __frame, function __$__59() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptTableNameIfNotGiven(options, tablename, __cb(_, __frame, 2, 30, function ___(__0, __2) {
          options.tablename = __2;
          return (function __$__59(__then) {
            if (!options.quiet) {
              return cli.interaction.confirm($("Do you really want to delete the table? [y/n]: "), __cb(_, __frame, 5, 32, function ___(__0, __4) {
                var __3 = (__4 === false);
                return (function __$__59(__then) {
                  if (__3) {
            ...
            progress = cli.interaction.progress($("Deleting table"));
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$__59() {
                  return mobile.deleteTable(options, __cb(_, __frame, 13, 19, function __$__59() {
                    _(null, null, true);
                  }, true));
                });
              })(function ___(__e, __r, __cont) {
    ...
    return __func(_, this, arguments, __60, 4, __frame, function __$__60() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        ...
        return promptTableNameIfNotGiven(options, tablename, __cb(_, __frame, 2, 30, function ___(__0, __2) {
          ...
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__60() {
                return mobile.getData(options, __cb(_, __frame, 9, 28, function ___(__0, __3) {
                  result = __3;
                  _(null, null, true);
                }, true));
              });
  ...
  mobileData.command("truncate [servicename] [tablename]").usage("[options] [servicename] [tablename]").description($("Delete all data from a mobile service table")).option("-q, --quiet", $("do not prompt for confirmation")).option("-s, --subscription <id>", $("the subscription id")).execute(function __61(servicename, tablename, options, _) {
    var result, progress;
    var __frame = {
      name: "__61",
      line: 3749
    };
    return __func(_, this, arguments, __61, 3, __frame, function __$__61() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptTableNameIfNotGiven(options, tablename, __cb(_, __frame, 2, 30, function ___(__0, __2) {
          options.tablename = __2;
          return (function __$__61(__then) {
            if (!options.quiet) {
              progress = cli.interaction.progress($("Retrieving table information"));
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$__61() {
                    return mobile.truncateTable(options, JSON.stringify({
                      confirm: false
                    }), __cb(_, __frame, 10, 30, function ___(__0, __3) {
                      result = __3;
                      _(null, null, true);
                    }, true));
                  });
                ...
                __tryCatch(_, function __$__61() {
                  ...
                  return cli.interaction.confirm($("Do you really want to delete all data from the table? [y/n]: "), __cb(_, __frame, 21, 33, function ___(__0, __5) {
                    var __4 = !__5;
                    return (function __$__61(__then) {
                      if (__4) {
            ...
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$__61() {
                  return mobile.truncateTable(options, JSON.stringify({
                    confirm: true
                  }), __cb(_, __frame, 29, 28, function ___(__0, __6) {
                    result = __6;
                    _(null, null, true);
                  }, true));
                });
  ...
  mobileData.command("delete [servicename] [tablename] [recordid]").description($("Delete a record from the mobile service table")).option("-q, --quiet", $("do not prompt for confirmation")).option("-s, --subscription <id>", $("the subscription id")).execute(function __62(servicename, tablename, recordid, options, _) {
    var progress;
    var __frame = {
      name: "__62",
      line: 3792
    };
    return __func(_, this, arguments, __62, 4, __frame, function __$__62() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptTableNameIfNotGiven(options, tablename, __cb(_, __frame, 2, 30, function ___(__0, __2) {
          options.tablename = __2;
          return promptIfNotGiven($("Record id: "), recordid, __cb(_, __frame, 3, 29, function ___(__0, __3) {
            options.recordid = __3;
            progress = cli.interaction.progress($("Deleting record"));
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$__62() {
                  return mobile.deleteTableRecord(options, __cb(_, __frame, 7, 19, function __$__62() {
                    _(null, null, true);
                  }, true));
                });
              })(function ___(__e, __r, __cont) {
  ...
  mobileScript.command("list [servicename]").description($("List mobile service scripts")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __63(servicename, options, _) {
    var progress, results;
    var __frame = {
      name: "__63",
      line: 3820
    };
    return __func(_, this, arguments, __63, 2, __frame, function __$__63() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        ...
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__63() {
              return mobile.loadAllScripts(options, __cb(_, __frame, 6, 29, function ___(__0, __2) {
                results = __2;
                _(null, null, true);
              }, true));
            });
          ...
          __tryCatch(_, function __$__63() {
            cli.interaction.formatOutput(results, function(scripts) {
              ...
              if (!scripts.api) {
                ...
                if (scripts.api.some(function(api) {
                  return (api.hasAdditionalPermissions === true);
                })) {
  ...
  mobileScript.command("download [servicename] [scriptname]").description($("Downloads a mobile service script")).option("-s, --subscription <id>", $("use the subscription id")).option("-f, --file <file>", $("file to save the script to")).option("-o, --override", $("override existing files")).option("-c, --console", $("write the script to the console instead of a file")).execute(function __64(servicename, scriptname, options, _) {
    var progress, script;
    var __frame = {
      name: "__64",
      line: 3965
    };
    return __func(_, this, arguments, __64, 3, __frame, function __$__64() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("Script: "), scriptname, __cb(_, __frame, 2, 31, function ___(__0, __2) {
          options.scriptname = __2;
          options.script = parseScriptName(options.scriptname);
          checkScriptName(options);
          progress = cli.interaction.progress(util.format($("Downloading script: '%s'"), options.scriptname));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__64() {
                return getScriptHandlers[options.script.type](options, __cb(_, __frame, 9, 21, function ___(__0, __3) {
                  script = __3;
                  _(null, null, true);
                }, true));
              });
  ...
  mobileScript.command("upload [servicename] [scriptname]").description($("Uploads a mobile service script")).option("-s, --subscription <id>", $("use the subscription id")).option("-f, --file <file>", $("file to read the script from")).execute(function __65(servicename, scriptname, options, _) {
    var script, progress;
    var __frame = {
      name: "__65",
      line: 3999
    };
    return __func(_, this, arguments, __65, 3, __frame, function __$__65() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("Script: "), scriptname, __cb(_, __frame, 2, 31, function ___(__0, __2) {
          options.scriptname = __2;
          ...
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__65() {
                script = fs.readFileSync(options.file, "utf8");
                __then();
              });
            })(function ___(e, __result) {
              __catch(function __$__65() {
                if (e) {
                  return _(new Error(util.format($("Unable to read script from file %s"), options.file)));
                }
                 else {
                  _(null, __result);
                }
            ...
            __tryCatch(_, function __$__65() {
              progress = cli.interaction.progress(util.format($("Uploading script: '%s'"), options.scriptname));
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$__65() {
                    return setScriptHandlers[options.script.type](options, script, __cb(_, __frame, 25, 12, function __$__65() {
                      _(null, null, true);
                    }, true));
                  });
                })(function ___(__e, __r, __cont) {
  ...
  mobileScript.command("delete [servicename] [scriptname]").description($("Deletes a mobile service script")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __66(servicename, scriptname, options, _) {
    var progress;
    var __frame = {
      name: "__66",
      line: 4040
    };
    return __func(_, this, arguments, __66, 3, __frame, function __$__66() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("Script: "), scriptname, __cb(_, __frame, 2, 31, function ___(__0, __2) {
          options.scriptname = __2;
          options.script = parseScriptName(options.scriptname);
          checkScriptName(options);
          progress = cli.interaction.progress(util.format($("Deleting script: '%s'"), options.scriptname));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__66() {
                return deleteScriptHandlers[options.script.type](options, __cb(_, __frame, 8, 12, function __$__66() {
                  _(null, null, true);
                }, true));
              });
            })(function ___(__e, __r, __cont) {
  ...
  mobileScale.command("show [servicename]").description($("Show the scale settings of a mobile service")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __67(servicename, options, _) {
    var result, progress;
    var __frame = {
      name: "__67",
      line: 4060
    };
    return __func(_, this, arguments, __67, 2, __frame, function __$__67() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress($("Retrieving scale settings"));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__67() {
              return mobile.getScaleSettings(options, __cb(_, __frame, 6, 28, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  mobileScale.command("change [servicename]").description($("Change the scale settings of a mobile service")).option("-s, --subscription <id>", $("use the subscription id")).option("-t, --tier <tier>", $("choose the free, basic or standard tier")).option("-i, --numberOfInstances <count>", $("number of instances in basic or standard mode")).option("-q, --quiet", $("do not prompt for confirmation")).execute(function __68(servicename, options, _) {
    var userSpecifiedTier, proceed, progress, scalesettings, newScaleSettings, scaleInfo;
    var __frame = {
      name: "__68",
      line: 4080
    };
    return __func(_, this, arguments, __68, 2, __frame, function __$__68() {
      ...
      ;
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 25, 32, function ___(__0, __1) {
        options.servicename = __1;
        return (function __$__68(__then) {
          if (((userSpecifiedTier === "standard") && !options.quiet)) {
            return cli.interaction.confirm($("Mobile service scale tiers have changed, set scale to Standard (previously Premium)? [y/n]: "), __cb(_, __frame, 27, 42, function ___(__0, __2) {
              proceed = __2;
              if (!proceed) {
          ...
          progress = cli.interaction.progress($("Rescaling the mobile service"));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__68() {
                return mobile.getScaleSettings(options, __cb(_, __frame, 37, 35, function ___(__0, __3) {
                  scalesettings = __3;
                  scalesettings.tier = findScale(scalesettings.tier, true);
                  __then();
                }, true));
              });
            })(function ___(e, __result) {
              __catch(function __$__68() {
                if (e) {
                  progress.end();
                  return _(e);
                }
            ...
            __tryCatch(_, function __$__68() {
              ...
              if ((scaleInfo.maxInstances < newScaleSettings.numberOfInstances)) {
                ...
                ;
                return _(new Error(util.format($("Cannot set number of instances to %d when the mobile service is in the %s tier. Valid values for this tier are 1 to %d."), newScaleSettings.numberOfInstances, scaleInfo.name, scaleInfo.maxInstances)));
              }
              ;
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$__68() {
                    return mobile.setScaleSettings(options, newScaleSettings, __cb(_, __frame, 72, 19, function __$__68() {
                      _(null, null, true);
                    }, true));
                  });
                })(function ___(__e, __r, __cont) {
  ...
  mobileJob.command("create [servicename] [jobname]").usage("[options] [servicename] [jobname]").description($("Create a mobile service scheduled job")).option("-i, --interval <number>", $("job interval as an integer; defaults to 15")).option("-u, --intervalUnit <unit>", $("specify one of: minute, hour, day, month or none for on-demand jobs; defaults to minute")).option("-t, --startTime <time>", $("time of the first run of the script in ISO format; defaults to now")).option("-s, --subscription <id>", $("the subscription id")).execute(function(servicename, jobname, options, callback) {
    ...
    ;
    if (!intervalUnits.some(function(unit) {
      return (unit === options.intervalUnit);
    })) {
  ...
  mobileJob.command("update [servicename] [jobname]").usage("[options] [servicename] [jobname]").description($("Update a mobile service scheduled job")).option("-i, --interval <number>", $("job interval as an integer")).option("-u, --intervalUnit <unit>", $("specify one of: minute, hour, day, month or none for on-demand jobs")).option("-t, --startTime <time>", $("time of the first run of the script in ISO format")).option("-a, --status <status>", $("enabled or disabled")).option("-s, --subscription <id>", $("the subscription id")).execute(function __69(servicename, jobname, options, _) {
    ...
    return __func(_, this, arguments, __69, 3, __frame, function __$__69() {
      ...
      ;
      if (((typeof options.intervalUnits !== "undefined") && !intervalUnits.some(function(unit) {
        return (unit === options.intervalUnit);
      }))) {
      ...
      ;
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 14, 32, function ___(__0, __1) {
        options.servicename = __1;
        return cli.interaction.chooseIfNotGiven($("Scheduled job name: "), $("Getting choices"), jobname, function(cb) {
          mobile.getSchedulerScripts(options, function(error, jobs) {
            ...
            cb(null, jobs.map(function(job) {
              return job.name;
            }));
          });
        }, __cb(_, __frame, 15, 44, function ___(__0, __2) {
          options.jobname = __2;
          progress = cli.interaction.progress($("Updating job settings"));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__69() {
                return mobile.getJob(options, __cb(_, __frame, 28, 25, function ___(__0, __3) {
                  job = __3;
                  __then();
                }, true));
              });
            })(function ___(e, __result) {
              __catch(function __$__69() {
                if (e) {
                  progress.end();
                  return _(e);
                }
            ...
            __tryCatch(_, function __$__69() {
              ...
              return (function __$__69(__then) {
                if (changed) {
                  return (function ___(__then) {
                    (function ___(_) {
                      __tryCatch(_, function __$__69() {
                        return mobile.setJob(options, newJob, __cb(_, __frame, 61, 21, __then, true));
                      });
                    })(function ___(e, __result) {
                      __catch(function __$__69() {
                        if (e) {
  ...
  mobilePreview.command("list [servicename]").description($("Show the preview features enabled for a mobile service")).option("-s, --subscription <id>", $("the subscription id")).execute(function __70(servicename, options, _) {
    var progress, result;
    var __frame = {
      name: "__70",
      line: 4375
    };
    return __func(_, this, arguments, __70, 2, __frame, function __$__70() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress($("Getting preview features"));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__70() {
              return mobile.getPreviews(options, __cb(_, __frame, 6, 28, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  mobilePreview.command("enable [servicename] [featurename]").usage("[options] [servicename] [featurename]").description($("Enable a preview feature for a mobile service. Note that preview features cannot be disabled for a mobile service!")).option("-s, --subscription <id>", $("the subscription id")).execute(function __71(servicename, featurename, options, _) {
    var progress, result;
    var __frame = {
      name: "__71",
      line: 4404
    };
    return __func(_, this, arguments, __71, 3, __frame, function __$__71() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        ...
        }, __cb(_, __frame, 2, 48, function ___(__0, __2) {
          options.featurename = __2;
          progress = cli.interaction.progress($("Enabling preview feature for mobile service"));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__71() {
                return mobile.enablePreview(options, {
                  enable: options.featurename
                }, __cb(_, __frame, 13, 28, function ___(__0, __3) {
                  result = __3;
                  _(null, null, true);
                }, true));
              });
  ...
  mobileApi.command("list [servicename]").description($("List mobile service custom APIs")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __72(servicename, options, _) {
    var progress, result;
    var __frame = {
      name: "__72",
      line: 4444
    };
    return __func(_, this, arguments, __72, 2, __frame, function __$__72() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress($("Retrieving list of APIs"));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__72() {
              return mobile.getCustomApis(options, __cb(_, __frame, 6, 28, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  mobileApi.command("create [servicename] [apiname]").description($("Creates a mobile service custom API")).option("-s, --subscription <id>", $("use the subscription id")).option("-p, --permissions <permissions>", $("comma delimited list of <method>=<permission> pairs")).execute(function __73(servicename, apiname, options, _) {
    var settings, progress;
    var __frame = {
      name: "__73",
      line: 4487
    };
    return __func(_, this, arguments, __73, 3, __frame, function __$__73() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("API name: "), apiname, __cb(_, __frame, 2, 28, function ___(__0, __2) {
          options.apiname = __2;
          ...
          progress = cli.interaction.progress(util.format($("Creating custom API: '%s'"), options.apiname));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__73() {
                return mobile.createApi(options, settings, __cb(_, __frame, 17, 19, function __$__73() {
                  _(null, null, true);
                }, true));
              });
            })(function ___(__e, __r, __cont) {
    ...
    return __func(_, this, arguments, __74, 3, __frame, function __$__74() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        ...
        return promptIfNotGiven($("API name: "), apiname, __cb(_, __frame, 2, 28, function ___(__0, __2) {
          ...
          ;
          settings = parsePermissions(options.permissions, methods);
          progress = cli.interaction.progress(util.format($("Updating API: '%s'"), options.apiname));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__74() {
                return mobile.getCustomApi(options, __cb(_, __frame, 13, 28, function ___(__0, __3) {
                  result = __3;
                  __then();
                }, true));
              });
            })(function ___(e, __result) {
              __catch(function __$__74() {
                if (e) {
                  progress.end();
                  return _(e);
                }
            ...
            __tryCatch(_, function __$__74() {
              ...
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$__74() {
                    return mobile.setCustomApi(options, settings, __cb(_, __frame, 38, 19, function __$__74() {
                      _(null, null, true);
                    }, true));
                  });
                })(function ___(__e, __r, __cont) {
  ...
  mobileApi.command("delete [servicename] [apiname]").description($("Deletes a mobile service custom API")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __75(servicename, apiname, options, _) {
    var progress;
    var __frame = {
      name: "__75",
      line: 4564
    };
    return __func(_, this, arguments, __75, 3, __frame, function __$__75() {
      return promptServiceNameIfNotGiven(options, servicename, nodeFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("API name: "), apiname, __cb(_, __frame, 2, 28, function ___(__0, __2) {
          options.apiname = __2;
          progress = cli.interaction.progress(util.format($("Deleting API: '%s'"), options.apiname));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__75() {
                return mobile.deleteCustomApi(options, __cb(_, __frame, 6, 28, function ___(__0, __3) {
                  result = __3;
                  _(null, null, true);
                }, true));
              });
  ...
  mobileAppSetting.command("list [servicename]").description($("Show your mobile application app settings")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __76(servicename, options, _) {
    var progress;
    var __frame = {
      name: "__76",
      line: 4582
    };
    return __func(_, this, arguments, __76, 2, __frame, function __$__76() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        progress = cli.interaction.progress($("Retrieving app settings"));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__76() {
              return mobile.getServiceSettings(options, __cb(_, __frame, 5, 28, function ___(__0, __2) {
                result = __2;
                _(null, null, true);
              }, true));
            });
  ...
  mobileAppSetting.command("add [servicename] [name] [value]").description($("Add an application setting for your mobile service")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __77(servicename, name, value, options, _) {
    var result, progress, lowerCaseName, setting;
    var __frame = {
      name: "__77",
      line: 4611
    };
    return __func(_, this, arguments, __77, 4, __frame, function __$__77() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("App setting name: "), name, __cb(_, __frame, 2, 32, function ___(__0, __2) {
          options.settingName = __2;
          return promptIfNotGiven($("App setting value: "), value, __cb(_, __frame, 3, 33, function ___(__0, __3) {
            options.settingValue = __3;
            progress = cli.interaction.progress($("Retrieving app settings"));
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$__77() {
                  return mobile.getServiceSettings(options, __cb(_, __frame, 8, 28, function ___(__0, __4) {
                    result = __4;
                    _(null, null, true);
                  }, true));
                });
              ...
              __tryCatch(_, function __$__77() {
                ...
                ;
                result.customApplicationSettings.push({
                ...
                return (function ___(__then) {
                  (function ___(_) {
                    __tryCatch(_, function __$__77() {
                      return mobile.setServiceSettings(options, result, __cb(_, __frame, 30, 28, function ___(__0, __5) {
                        result = __5;
                        _(null, null, true);
                      }, true));
                    });
  ...
  mobileAppSetting.command("delete [servicename] [name]").description($("Remove an application setting for your mobile service")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __78(servicename, name, options, _) {
    var result, progress, lowerCaseName, newAppSettings;
    var __frame = {
      name: "__78",
      line: 4650
    };
    return __func(_, this, arguments, __78, 3, __frame, function __$__78() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("App setting name: "), name, __cb(_, __frame, 2, 32, function ___(__0, __2) {
          options.settingName = __2;
          ...
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__78() {
                return mobile.getServiceSettings(options, __cb(_, __frame, 7, 28, function ___(__0, __3) {
                  result = __3;
                  _(null, null, true);
                }, true));
              });
            ...
            __tryCatch(_, function __$__78() {
              ...
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$__78() {
                    return mobile.setServiceSettings(options, result, __cb(_, __frame, 28, 28, function ___(__0, __4) {
                      result = __4;
                      _(null, null, true);
                    }, true));
                  });
  ...
  mobileAppSetting.command("show [servicename] [name]").description($("Show an application setting for your mobile service")).option("-s, --subscription <id>", $("use the subscription id")).execute(function __79(servicename, name, options, _) {
    var result, progress, lowerCaseName, setting;
    var __frame = {
      name: "__79",
      line: 4687
    };
    return __func(_, this, arguments, __79, 3, __frame, function __$__79() {
      return promptServiceNameIfNotGiven(options, servicename, defaultFilter, __cb(_, __frame, 1, 32, function ___(__0, __1) {
        options.servicename = __1;
        return promptIfNotGiven($("App setting name: "), name, __cb(_, __frame, 2, 32, function ___(__0, __2) {
          options.settingName = __2;
