...
exports.init = function(cli) {
  ...
  siteScale.command("mode [mode] [name]").description($("Set the web site mode")).usage("[options] <mode> [name]").option("--mode <mode>", $("the mode of the site (available are: free, basic, shared and standard)")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(mode, name, options, _) {
    var parsedSiteName, context, service, siteConfigurations, webHostingPlanName, webHostingPlanConfig;
    var __frame = {
      name: "__1",
      line: 35
    };
    return __func(_, this, arguments, __1, 3, __frame, function __$__1() {
      return cli.interaction.chooseIfNotGiven($("Mode: "), $("Getting modes"), mode, function(cb) {
      ...
      }, __cb(_, __frame, 1, 29, function ___(__0, __1) {
        mode = __1;
        ...
        return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 15, 11, function __$__1() {
          ...
          return site.doSiteGet(context, __cb(_, __frame, 19, 36, function ___(__0, __2) {
            siteConfigurations = __2;
            webHostingPlanName = siteConfigurations.serverFarm;
            webHostingPlanConfig = {
            };
            webHostingPlanConfig.sKU = mode;
            return service.webHostingPlans.update(context.site.webspace, webHostingPlanName, webHostingPlanConfig, __cb(_, __frame, 25, 30, function __$__1() {
              _();
            }, true));
          }, true));
        }, true));
  ...
  siteScale.command("instances [instances] [name]").description($("Set the web site number of instances")).usage("[options] <instances> [name]").option("--instances <instances>", $("the number of instances")).option("--size <size>", $("the size of the instances (available are: small, medium and large)")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(instances, name, options, _) {
    var parsedSiteName, context, service, siteConfigurations, webHostingPlanName, webHostingPlanConfig, progress;
    var __frame = {
      name: "__2",
      line: 70
    };
    return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
      return cli.interaction.promptIfNotGiven($("Number of instances: "), instances, __cb(_, __frame, 1, 34, function ___(__0, __1) {
        instances = __1;
        parsedSiteName = WebsitesClient.parseSiteName(name);
        context = {
          subscription: profile.current.getSubscription(options.subscription).id,
        ...
        return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 14, 11, function __$__2() {
          return site.doSiteGet(context, __cb(_, __frame, 15, 36, function ___(__0, __2) {
            siteConfigurations = __2;
            ...
            progress = cli.interaction.progress($("Updating a web hosting plan"));
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$__2() {
                  return service.webHostingPlans.update(context.site.webspace, webHostingPlanName, webHostingPlanConfig, __cb(_, __frame, 34, 32, function __$__2() {
                    _(null, null, true);
                  }, true));
                });
