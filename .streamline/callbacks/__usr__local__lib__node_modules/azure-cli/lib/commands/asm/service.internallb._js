...
exports.init = function(cli) {
  ...
  var log = cli.output;
  internallb.command("list [serviceName]").description($("List internal load balancers for a cloud service deployment")).usage("[options] [serviceName]").option("-r, --serviceName <serviceName>", $("the cloud service name")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(serviceName, options, _) {
    var computeClient, progress, deployment, loadBalancers;
    var __frame = {
      name: "__1",
      line: 33
    };
    return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
      return cli.interaction.promptIfNotGiven($("Cloud Service name: "), serviceName, __cb(_, __frame, 1, 36, function ___(__0, __1) {
        serviceName = __1;
        computeClient = utils._createComputeClient(profile.current.getSubscription(options.subscription), log);
        progress = cli.interaction.progress($("Getting cloud service deployment"));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__1() {
              return computeClient.deployments.getBySlot(serviceName, "Production", __cb(_, __frame, 7, 47, function ___(__0, __2) {
                deployment = __2;
                _(null, null, true);
              }, true));
            });
  ...
  internallb.command("add [serviceName] [internalLBName]").usage("[options] [serviceName] [internalLBName]").description($("Add an internal load balancer for a cloud service deployment")).option("-r, --serviceName <serviceName>", $("the cloud service name")).option("-n, --internalLBName <internalLBName>", $("the internal load balancer name")).option("-t, --subnet-name <name>", $("the name of the subnet in the virtual network that the load balancer uses")).option("-a, --static-virtualnetwork-ipaddress <ip-address>", $("specific virtual IP address that the load balancer uses from the subnet in the virtual network")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(serviceName, internalLBName, options, _) {
    ...
    return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
      return cli.interaction.promptIfNotGiven($("Cloud Service name: "), serviceName, __cb(_, __frame, 1, 36, function ___(__0, __1) {
        serviceName = __1;
        return cli.interaction.promptIfNotGiven($("Internal Load Balancer name: "), internalLBName, __cb(_, __frame, 2, 39, function ___(__0, __2) {
          internalLBName = __2;
          computeClient = utils._createComputeClient(profile.current.getSubscription(options.subscription), log);
          progress = cli.interaction.progress($("Getting cloud service deployment"));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__2() {
                return computeClient.deployments.getBySlot(serviceName, "Production", __cb(_, __frame, 8, 47, function ___(__0, __3) {
                  deployment = __3;
                  _(null, null, true);
                }, true));
              });
            ...
            __tryCatch(_, function __$__2() {
              ...
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$__2() {
                    return computeClient.loadBalancers.create(serviceName, deployment.name, internalLoadBalancerConfig, __cb(_, __frame, 34, 36, function __$__2() {
                      _(null, null, true);
                    }, true));
                  });
                })(function ___(__e, __r, __cont) {
  ...
  internallb.command("delete [serviceName] [internalLBName]").usage("[options] [serviceName] [internalLBName]").description($("Delete an internal load balancer for a cloud service deployment")).option("-r, --serviceName <serviceName>", $("the cloud service name")).option("-n, --internalLBName <internalLBName>", $("the internal load balancer name")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <id>", $("the subscription id")).execute(function __3(serviceName, internalLBName, options, _) {
    var computeClient, progress, deployment;
    var __frame = {
      name: "__3",
      line: 127
    };
    return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      return cli.interaction.promptIfNotGiven($("Cloud Service name: "), serviceName, __cb(_, __frame, 1, 36, function ___(__0, __2) {
        serviceName = __2;
        return cli.interaction.promptIfNotGiven($("Internal Load Balancer name: "), internalLBName, __cb(_, __frame, 2, 39, function ___(__0, __3) {
          internalLBName = __3;
          computeClient = utils._createComputeClient(profile.current.getSubscription(options.subscription), log);
          progress = cli.interaction.progress($("Getting cloud service deployment"));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__3() {
                return computeClient.deployments.getBySlot(serviceName, "Production", __cb(_, __frame, 8, 47, function ___(__0, __4) {
                  deployment = __4;
                  _(null, null, true);
                }, true));
              });
              ...
              return (function __$__3(__then) {
                if (loadBalancer) {
                  return (function __$__3(_) {
                    ...
                    ;
                    return cli.interaction.confirm(util.format($("Delete internal load balancer with name %s? [y/n] "), internalLBName), __cb(_, __frame, 15, 47, function ___(__0, __3) {
                      var __2 = !__3;
                      return _(null, __2);
                    }, true));
                    ...
                    return (function __$__3(__then) {
                      ...
                      return (function ___(__then) {
                        (function ___(_) {
                          __tryCatch(_, function __$__3() {
                            return computeClient.loadBalancers.deleteMethod(serviceName, deployment.name, loadBalancer.name, __cb(_, __frame, 21, 38, function __$__3() {
                              _(null, null, true);
                            }, true));
                          });
                        })(function ___(__e, __r, __cont) {
  ...
  internallb.command("set [serviceName] [internalLBName]").description($("Update internal load balancer of a cloud service deployment")).option("-r, --serviceName <serviceName>", $("the cloud service name")).option("-n, --internalLBName <internalLBName>", $("the internal load balancer name")).option("-t, --subnet-name <name>", $("the name of the subnet in the virtual network that the load balancer uses")).option("-a, --static-virtualnetwork-ipaddress <ip-address>", $("specific virtual IP address that the load balancer uses from the subnet in the virtual network")).option("-d, --remove-subnet", $("remove subnet entry if it is already defined for the internal load balancer")).option("-e, --remove-vnetip", $("remove virtual network IP address if it is already defined for the internal load balancer")).option("-s, --subscription <id>", $("the subscription id")).execute(function __4(serviceName, internalLBName, options, _) {
    ...
    return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
      ...
      ;
      return cli.interaction.promptIfNotGiven($("Cloud Service name: "), serviceName, __cb(_, __frame, 18, 36, function ___(__0, __1) {
        serviceName = __1;
        return cli.interaction.promptIfNotGiven($("Internal Load Balancer name: "), internalLBName, __cb(_, __frame, 19, 39, function ___(__0, __2) {
          internalLBName = __2;
          computeClient = utils._createComputeClient(profile.current.getSubscription(options.subscription), log);
          progress = cli.interaction.progress($("Getting cloud service deployment"));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__4() {
                return computeClient.deployments.getBySlot(serviceName, "Production", __cb(_, __frame, 26, 47, function ___(__0, __3) {
                  deployment = __3;
                  _(null, null, true);
                }, true));
              });
              ...
              return (function __$__4(__then) {
                if (loadBalancer) {
                  ...
                  return (function ___(__then) {
                    (function ___(_) {
                      __tryCatch(_, function __$__4() {
                        return computeClient.loadBalancers.update(serviceName, deployment.name, loadBalancer.name, loadBalancer, __cb(_, __frame, 56, 38, function __$__4() {
                          _(null, null, true);
                        }, true));
                      });
                    })(function ___(__e, __r, __cont) {
