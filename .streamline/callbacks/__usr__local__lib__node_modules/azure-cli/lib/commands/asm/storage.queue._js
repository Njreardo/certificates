...
exports.init = function(cli) {
  ...
  queueSas.command("create [queue] [permissions] [expiry]").description($("Generate shared access signature of storage queue")).option("--queue <queue>", $("the storage queue name")).option("--permissions <permissions>", $("the operation permissions combining symbols of r(Read)/a(Add)/u(Update)/p(Process)")).option("--start <start>", $("the UTC time at which the SAS becomes valid")).option("--expiry <expiry>", $("the UTC time at which the SAS expires")).option("--policy <policy>", $("the stored access policy identifier")).addStorageAccountOption().execute(createQueueSAS);
  ...
  function createQueue(queue, options, _) {
    var queueService, operation, tips, storageOptions, created;
    var __frame = {
      name: "createQueue",
      line: 206
    };
    return __func(_, this, arguments, createQueue, 2, __frame, function __$createQueue() {
      queueService = getQueueServiceClient(options);
      return interaction.promptIfNotGiven($("Queue name: "), queue, __cb(_, __frame, 2, 24, function ___(__0, __1) {
        queue = __1;
        ...
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$createQueue() {
              return performStorageOperation(operation, __cb(_, __frame, 8, 20, function ___(__0, __2) {
                created = __2;
                if ((created === false)) {
                  return _(new Error(util.format($("Queue '%s' already exists"), queue)));
                }
                ;
                _(null, null, true);
              }, true), queue, storageOptions);
            });
          ...
          __tryCatch(_, function __$createQueue() {
            ...
            return showQueue(queue, StorageUtil.getStorageAccountOptions(options), __cb(_, __frame, 17, 4, function __$createQueue() {
              _();
            }, true));
          });
        });
  ...
  function deleteQueue(queue, options, _) {
    var queueService, operation, tips, storageOptions;
    var __frame = {
      name: "deleteQueue",
      line: 232
    };
    return __func(_, this, arguments, deleteQueue, 2, __frame, function __$deleteQueue() {
      queueService = getQueueServiceClient(options);
      return interaction.promptIfNotGiven($("Queue name: "), queue, __cb(_, __frame, 2, 24, function ___(__0, __1) {
        queue = __1;
        ...
        storageOptions = getStorageQueueOperationDefaultOption();
        return (function __$deleteQueue(__then) {
          if (!options.quiet) {
            return interaction.confirm(util.format($("Do you want to delete queue %s? "), queue), __cb(_, __frame, 8, 23, function ___(__0, __3) {
              var __2 = !__3;
              return (function __$deleteQueue(__then) {
                if (__2) {
                  return _(null);
          ...
          ;
        })(function __$deleteQueue() {
          startProgress(tips);
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$deleteQueue() {
                return (function ___(__then) {
                  (function ___(_) {
                    __tryCatch(_, function __$deleteQueue() {
                      return performStorageOperation(operation, __cb(_, __frame, 16, 6, __then, true), queue, storageOptions);
                    });
                  })(function ___(e, __result) {
                    __catch(function __$deleteQueue() {
                      if (e) {
  ...
  function showQueue(queue, options, _) {
    var queueService, operation, tips, storageOptions, output, exist, info;
    var __frame = {
      name: "showQueue",
      line: 268
    };
    return __func(_, this, arguments, showQueue, 2, __frame, function __$showQueue() {
      queueService = getQueueServiceClient(options);
      return interaction.promptIfNotGiven($("Queue name: "), queue, __cb(_, __frame, 2, 24, function ___(__0, __1) {
        queue = __1;
                    ...
                    return performStorageOperation(operation, __cb(_, __frame, 10, 18, function ___(__0, __2) {
                      ...
                      return (function __$showQueue(__then) {
                        if (!exist) {
                          ...
                          return performStorageOperation(operation, __cb(_, __frame, 16, 24, function ___(__0, __3) {
                            info.metadata = __3;
                            return (function __$showQueue(__then) {
                              if (!options.sas) {
                                operation = getStorageQueueOperation(queueService, "getQueueAcl");
                                return performStorageOperation(operation, __cb(_, __frame, 20, 26, function ___(__0, __4) {
                                  info.policies = __4;
                                  __then();
                                }, true), queue, storageOptions);
                              }
  ...
  function listQueue(prefix, options, _) {
    var queueService, listOperation, tips, queueOptions, useWildcard, queues;
    var __frame = {
      name: "listQueue",
      line: 332
    };
    return __func(_, this, arguments, listQueue, 2, __frame, function __$listQueue() {
      queueService = getQueueServiceClient(options);
      ...
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$listQueue() {
            return performStorageOperation(listOperation, __cb(_, __frame, 18, 6, function ___(__0, __2) {
              return __2.forEach_(__cb(_, __frame, 18, 62, function __$listQueue() {
                _(null, null, true);
              }, true), StorageUtil.opConcurrency, function __1(_, queue) {
                var info;
                var __frame = {
                  name: "__1",
                  line: 350
  ...
  function createQueueSAS(queue, permissions, expiry, options, _) {
    var queueService, start, output, sharedAccessPolicy, tips;
    var __frame = {
      name: "createQueueSAS",
      line: 375
    };
    return __func(_, this, arguments, createQueueSAS, 4, __frame, function __$createQueueSAS() {
      queueService = getQueueServiceClient(options);
      return interaction.promptIfNotGiven($("Queue name: "), queue, __cb(_, __frame, 2, 24, function ___(__0, __1) {
        queue = __1;
        return (function __$createQueueSAS(__then) {
          if (!options.policy) {
          ...
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$createQueueSAS() {
  ...
  function createQueuePolicy(queue, name, options, _) {
    ...
    var __frame = {
      name: "createQueuePolicy",
      line: 423
    };
    return __func(_, this, arguments, createQueuePolicy, 3, __frame, function __$createQueuePolicy() {
      createPolicySettings = createQueuePolicySetting(options);
      return interaction.promptIfNotGiven($("Queue name: "), queue, __cb(_, __frame, 2, 52, function ___(__0, __1) {
  ...
  function listQueuePolicy(queue, options, _) {
    ...
    var __frame = {
      name: "listQueuePolicy",
      line: 443
    };
    return __func(_, this, arguments, listQueuePolicy, 2, __frame, function __$listQueuePolicy() {
      listPolicySettings = createQueuePolicySetting(options);
      return interaction.promptIfNotGiven($("Queue name: "), queue, __cb(_, __frame, 2, 50, function ___(__0, __1) {
  ...
  function showQueuePolicy(queue, name, options, _) {
    ...
    var __frame = {
      name: "showQueuePolicy",
      line: 461
    };
    return __func(_, this, arguments, showQueuePolicy, 3, __frame, function __$showQueuePolicy() {
  ...
  function setQueuePolicy(queue, name, options, _) {
    ...
    return __func(_, this, arguments, setQueuePolicy, 3, __frame, function __$setQueuePolicy() {
      setPolicySettings = createQueuePolicySetting(options);
      return interaction.promptIfNotGiven($("Queue name: "), queue, __cb(_, __frame, 2, 49, function ___(__0, __1) {
  ...
  function deleteQueuePolicy(queue, name, options, _) {
    ...
    var __frame = {
      name: "deleteQueuePolicy",
      line: 496
    };
    return __func(_, this, arguments, deleteQueuePolicy, 3, __frame, function __$deleteQueuePolicy() {
