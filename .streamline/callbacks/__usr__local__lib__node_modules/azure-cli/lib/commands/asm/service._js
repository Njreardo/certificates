...
exports.init = function(cli) {
  ...
  cloudService.command("create [serviceName]").description($("Create a cloud service")).usage("[options] <serviceName>").option("--serviceName <serviceName>", $("the cloud service name")).option("--description <description>", $("the description. Defaults to 'Service host'")).option("--location <location>", $("the location. Optional if affinitygroup is specified")).option("--affinitygroup <affinitygroup>", $("the affinity group. Optional if location is specified")).option("--label <label>", $("the label. Defaults to serviceName")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(serviceName, options, _) {
    ...
    return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
      ...
      return cli.interaction.promptIfNotGiven($("New cloud service name: "), serviceName, __cb(_, __frame, 4, 36, function ___(__0, __1) {
        serviceName = __1;
        ...
        return (function __$__1(__then) {
          if ((!location && !affinitygroup)) {
            ...
            }, __cb(_, __frame, 10, 35, function ___(__0, __2) {
              location = __2;
              __then();
            }, true));
          }
          ...
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__1() {
                return service.hostedServices.create(createOptions, __cb(_, __frame, 44, 31, function __$__1() {
                  _(null, null, true);
                }, true));
              });
  ...
  cloudService.command("list").description($("List Azure cloud services")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(options, _) {
    var service, cloudServices, progress;
    var __frame = {
      name: "__2",
      line: 98
    };
    return __func(_, this, arguments, __2, 1, __frame, function __$__2() {
      service = utils._createComputeClient(profile.current.getSubscription(options.subscription), log);
      progress = cli.interaction.progress($("Getting cloud services"));
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$__2() {
            return service.hostedServices.list(__cb(_, __frame, 7, 47, function ___(__0, __1) {
              cloudServices = __1.hostedServices;
              _(null, null, true);
            }, true));
          });
        })(function ___(__e, __r, __cont) {
  ...
  cloudService.command("show [serviceName]").description($("Show Azure cloud service")).usage("[options] <serviceName>").option("--serviceName <serviceName>", $("the cloud service name")).option("-s, --subscription <id>", $("the subscription id")).execute(function __3(serviceName, options, _) {
    var service, progress, cloudService;
    var __frame = {
      name: "__3",
      line: 128
    };
    return __func(_, this, arguments, __3, 2, __frame, function __$__3() {
      service = utils._createComputeClient(profile.current.getSubscription(options.subscription), log);
      return cli.interaction.promptIfNotGiven($("Cloud Service name: "), serviceName, __cb(_, __frame, 3, 36, function ___(__0, __1) {
        serviceName = __1;
        progress = cli.interaction.progress($("Getting cloud service"));
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$__3() {
              return service.hostedServices.get(serviceName, __cb(_, __frame, 8, 46, function ___(__0, __2) {
                cloudService = __2;
                _(null, null, true);
              }, true));
            });
  ...
  cloudService.command("delete [serviceName]").description($("Delete a cloud service")).usage("[options] <serviceName>").option("--serviceName <serviceName>", $("the cloud service name")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <id>", $("the subscription id")).execute(function __4(serviceName, options, _) {
    ...
    return __func(_, this, arguments, __4, 2, __frame, function __$__4() {
      service = utils._createComputeClient(profile.current.getSubscription(options.subscription), log);
      return cli.interaction.promptIfNotGiven($("Cloud service name: "), serviceName, __cb(_, __frame, 3, 36, function ___(__0, __2) {
        serviceName = __2;
        return (function __$__4(_) {
          ...
          ;
          return cli.interaction.confirm(util.format($("Delete cloud service %s? [y/n] "), serviceName), __cb(_, __frame, 5, 45, function ___(__0, __3) {
            var __2 = !__3;
            return _(null, __2);
          }, true));
        })(__cb(_, __frame, -163, 18, function ___(__0, __3) {
            ...
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$__4() {
                  return service.hostedServices.deleteMethod(serviceName, __cb(_, __frame, 11, 31, function __$__4() {
                    _(null, null, true);
                  }, true));
                });
              })(function ___(__e, __r, __cont) {
