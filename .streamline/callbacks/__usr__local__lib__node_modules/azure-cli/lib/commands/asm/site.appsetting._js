...
exports.init = function(cli) {
  ...
  siteAppsettings.listCommand = function siteAppsettings_listCommand__1(name, options, _) {
    var parsedSiteName, context, siteConfigurations;
    var __frame = {
      name: "siteAppsettings_listCommand__1",
      line: 33
    };
    return __func(_, this, arguments, siteAppsettings_listCommand__1, 2, __frame, function __$siteAppsettings_listCommand__1() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 10, 11, function __$siteAppsettings_listCommand__1() {
        return site.doSiteConfigGet(context, __cb(_, __frame, 12, 36, function ___(__0, __1) {
          siteConfigurations = __1;
  ...
  siteAppsettings.addCommand = function siteAppsettings_addCommand__2(keyvaluepair, name, options, _) {
    var parsedSiteName, context, settings, siteConfigurations, setting;
    var __frame = {
      name: "siteAppsettings_addCommand__2",
      line: 60
    };
    return __func(_, this, arguments, siteAppsettings_addCommand__2, 3, __frame, function __$siteAppsettings_addCommand__2() {
      parsedSiteName = WebsitesClient.parseSiteName(name);
      context = {
        subscription: profile.current.getSubscription(options.subscription).id,
        site: {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 13, 9, function __$siteAppsettings_addCommand__2() {
        return site.doSiteConfigGet(context, __cb(_, __frame, 14, 34, function ___(__0, __1) {
          siteConfigurations = __1;
          ...
          ;
          return site.doSiteConfigPUT(siteConfigurations, context, __cb(_, __frame, 32, 9, function __$siteAppsettings_addCommand__2() {
            _();
          }, true));
        }, true));
      }, true));
  ...
  siteAppsettings.deleteCommand = function siteAppsettings_deleteCommand__3(key, name, options, _) {
    var parsedSiteName, context, siteConfigurations, found;
    var __frame = {
      name: "siteAppsettings_deleteCommand__3",
      line: 95
    };
    return __func(_, this, arguments, siteAppsettings_deleteCommand__3, 3, __frame, function __$siteAppsettings_deleteCommand__3() {
      parsedSiteName = WebsitesClient.parseSiteName(name);
      context = {
        subscription: profile.current.getSubscription(options.subscription).id,
        site: {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 11, 9, function __$siteAppsettings_deleteCommand__3() {
        return site.doSiteConfigGet(context, __cb(_, __frame, 12, 34, function ___(__0, __2) {
          siteConfigurations = __2;
          found = false;
          return (function __$siteAppsettings_deleteCommand__3(__then) {
            if (siteConfigurations.appSettings) {
              ...
              return (function __$siteAppsettings_deleteCommand__3(__then) {
                if (found) {
                  return (function __$siteAppsettings_deleteCommand__3(_) {
                    var __1 = !options.quiet;
                    if (!__1) {
                      return _(null, __1);
                    }
                    ;
                    return cli.interaction.confirm(util.format($("Delete application setting %s? [y/n] "), key), __cb(_, __frame, 24, 47, function ___(__0, __3) {
                      var __2 = !__3;
                      return _(null, __2);
                    }, true));
                  })(__cb(_, __frame, -94, 18, function ___(__0, __3) {
                    return (function __$siteAppsettings_deleteCommand__3(__then) {
                      if (__3) {
                        return _(null);
                      }
                      ...
                      return site.doSiteConfigPUT(siteConfigurations, context, __cb(_, __frame, 28, 13, __then, true));
                    });
                  }, true));
                }
                 else {
            ...
            if (!found) {
              return _(new Error(util.format($("Application setting with key \"%s\" does not exist"), key)));
            }
            ;
            _();
          });
  ...
  siteAppsettings.showCommand = function siteAppsettings_showCommand__4(key, name, options, _) {
    var parsedSiteName, context, siteConfigurations, found;
    var __frame = {
      name: "siteAppsettings_showCommand__4",
      line: 132
    };
    return __func(_, this, arguments, siteAppsettings_showCommand__4, 3, __frame, function __$siteAppsettings_showCommand__4() {
      parsedSiteName = WebsitesClient.parseSiteName(name);
      context = {
        subscription: profile.current.getSubscription(options.subscription).id,
        site: {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 11, 9, function __$siteAppsettings_showCommand__4() {
        return site.doSiteConfigGet(context, __cb(_, __frame, 12, 34, function ___(__0, __1) {
          siteConfigurations = __1;
          found = false;
          if (siteConfigurations.appSettings) {
            Object.keys(siteConfigurations.appSettings).forEach(function(currentKey) {
