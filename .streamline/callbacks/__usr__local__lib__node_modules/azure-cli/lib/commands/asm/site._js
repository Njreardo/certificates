...
exports.init = function(cli) {
  ...
  site.command("list [name]").description($("List your web sites")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(name, options, _) {
    var context, sites;
    var __frame = {
      name: "__1",
      line: 57
    ...
    return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
      ...
      return ensureSpaces(context, __cb(_, __frame, 6, 10, function __$__1() {
        return site.doSitesGet(context, __cb(_, __frame, 7, 27, function ___(__0, __1) {
          sites = __1;
          if (name) {
  ...
  site.command("set [name]").description($("Set configuration options for your web site [name]")).option("--slot <slot>", $("the name of the slot")).option("--net-version <net-version>", $("the .NET version. Valid options are v3.5 and v4.5")).option("--php-version <php-version>", $("the PHP version. Valid options are off, v5.3 and v5.4")).option("--platform <platform>", $("the platform. Valid options are x86 and x64")).option("-w, --web-socket", $("use this flag to enable web sockets")).option("-W, --disable-web-socket", $("use this flag to disable web sockets")).option("-r, --remote-debugging", $("use this flag to enable remote debugging")).option("-R, --disable-remote-debugging", $("use this flag to disable remote debugging")).option("-d, --remote-debugging-version <remote-debugging-version>", $("the version of remote debugging. It's either VS2012 or VS2013. This parameter is only valid when remote debugging is on.")).option("-m, --managed-pipeline-mode <managed-pipeline-mode>", $("the mode for managed pipeline. valid values are Classic and Integrated.")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(name, options, _) {
    ...
    return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      if (options.phpVersion) {
        validation.isValidEnumValue(options.phpVersion, ["off","5.3","5.4","5.5",]);
      }
      ;
      if (options.platform) {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 26, 11, function __$__2() {
        ...
        ;
        return site.doSiteConfigPUT(siteConfigurations, context, __cb(_, __frame, 67, 11, function __$__2() {
          _();
        }, true));
      }, true));
    });
  ...
  deploymentScriptCommand.execute(function __3(name, options, _) {
    var option;
    var __frame = {
      name: "__3",
      line: 176
  ...
  site.command("create [name]").description($("Create a web site")).option("--location <location>", $("the geographic region to create the website")).option("--hostname <hostname>", $("the custom host name to use")).option("--slot <slot>", $("the name of the slot")).option("--git", $("Configure git on web site and local folder")).option("--gitusername <gitusername>", $("the publishing username for git")).option("--github", $("Configure github on web site and local folder")).option("--githubusername <username>", $("the github username")).option("--githubpassword <password>", $("the github password")).option("--githubrepository <repository>", $("the github repository full name (i.e. user/repository)")).option("-s, --subscription <id>", $("the subscription id")).execute(function __4(nameArg, options, _) {
      ...
      return __func(_, this, arguments, promptForSiteName, 0, __frame, function __$promptForSiteName() {
        ...
        return (function __$promptForSiteName(__then) {
          if ((context.site.name === undefined)) {
            ...
            return cli.interaction.prompt($("Name: "), __cb(_, __frame, 4, 50, function ___(__0, __1) {
              context.site.name = __1;
              __then();
            }, true));
          }
           else {
    ...
    function determineIfSiteAndSlotExists(_) {
      var sites, siteHits, displayNameMatches, slotHits, displaySlotNameMatches;
      var __frame = {
        name: "determineIfSiteAndSlotExists",
        line: 282
      };
      return __func(_, this, arguments, determineIfSiteAndSlotExists, 0, __frame, function __$determineIfSiteAndSlotExists() {
        log.silly("determineIfSiteAndSlotExists");
        return site.doSitesGet(context, __cb(_, __frame, 2, 29, function ___(__0, __1) {
          sites = __1;
          siteHits = sites.filter(function(item) {
            return utils.ignoreCaseEquals(item.name, context.site.name);
          });
          return (function __$determineIfSiteAndSlotExists(__then) {
                ...
                if ((context.site.webspace === undefined)) {
                  ...
                  return ensureSpaces(context, __cb(_, __frame, 15, 16, function __$determineIfSiteAndSlotExists() {
                    ...
                    if ((displayNameMatches && (displayNameMatches.Name !== siteHits[0].WebSpace))) {
                      return _(new Error(util.format($("Expected location %s but was %s"), context.site.webspace, displayNameMatches.GeoRegion)));
                    }
                    ;
                    __then();
                  }, true));
            ...
            ;
          })(function __$determineIfSiteAndSlotExists() {
            return (function __$determineIfSiteAndSlotExists(__then) {
                        ...
                        return (function __$determineIfSiteAndSlotExists(__then) {
                          if ((context.site.webspace === undefined)) {
                            ...
                            return ensureSpaces(context, __cb(_, __frame, 39, 20, function __$determineIfSiteAndSlotExists() {
                              displaySlotNameMatches = context.spaces.filter(function(space) {
                                return (space.GeoRegion === context.site.webspace);
                              })[0];
                              if ((displaySlotNameMatches && (displaySlotNameMatches.Name !== siteHits[0].WebSpace))) {
                                return _(new Error(util.format($("Expected location %s but was %s"), context.site.webspace, displaySlotNameMatches.GeoRegion)));
                              }
                              ;
                              __then();
                            }, true));
    ...
    function promptForLocation(_) {
      ...
      return __func(_, this, arguments, promptForLocation, 0, __frame, function __$promptForLocation() {
        ...
        return ensureSpaces(context, __cb(_, __frame, 2, 12, function __$promptForLocation() {
          return site.doAvailableLocationsGet(context, __cb(_, __frame, 4, 33, function ___(__0, __1) {
            locations = __1;
            location = null;
            return (function __$promptForLocation(__then) {
              if ((!context.site.location && !context.site.webspace)) {
                ...
                }), __cb(_, __frame, 9, 51, function ___(__0, __2) {
                  location = locations[__2];
                  __then();
                }, true));
              }
               else {
      ...
      return __func(_, this, arguments, updateLocalConfigWithSiteName, 0, __frame, function __$updateLocalConfigWithSiteName() {
        ...
        return (function __$updateLocalConfigWithSiteName(__then) {
          if (context.flags.isGitWorkingTree) {
            return websiteClient.readConfig(__cb(_, __frame, 3, 38, function ___(__0, __1) {
              cfg = __1;
              ...
              return websiteClient.writeConfig(cfg, __cb(_, __frame, 7, 28, __then, true));
            }, true));
          }
           else {
            __then();
    ...
    function createSite(_) {
      var site, websiteAddress;
      var __frame = {
        name: "createSite",
        line: 379
      };
      return __func(_, this, arguments, createSite, 0, __frame, function __$createSite() {
        log.silly("createSite");
        return (function __$createSite(__then) {
          if (!context.flags.siteExists) {
            ...
            return websiteClient.getHostNameSuffix(context.subscription, __cb(_, __frame, 14, 75, function ___(__0, __1) {
              websiteAddress = ((context.site.name + ".") + __1);
              ...
              ;
              return websiteClient.createSite(context.subscription, context.site.webspace, site, __cb(_, __frame, 21, 35, _, true));
            }, true));
          }
           else {
            __then();
    ...
    function createSiteSlot(_) {
      ...
      return __func(_, this, arguments, createSiteSlot, 0, __frame, function __$createSiteSlot() {
        log.silly("createSiteSlot");
        return (function __$createSiteSlot(__then) {
          if ((context.site.slot && !context.flags.siteSlotExists)) {
            ...
            return websiteClient.createSite(context.subscription, context.site.webspace, site, __cb(_, __frame, 9, 35, _, true));
          }
           else {
            __then();
          }
    ...
    return __func(_, this, arguments, __4, 2, __frame, function __$__4() {
      ...
      if ((options.git && options.github)) {
        return _(new Error($("Please run the command with either --git or --github options. Not both")));
      }
      ;
      if (options.git) {
      ...
      return promptForSiteName(__cb(_, __frame, 33, 10, function __$__4() {
        return determineIfSiteAndSlotExists(__cb(_, __frame, 35, 10, function __$__4() {
          if ((!context.flags.siteExists && context.site.slot)) {
            return _(new Error($("Can't create a slot for a site that does not exist")));
          }
          ;
          return promptForLocation(__cb(_, __frame, 41, 10, function __$__4() {
            ...
            return (function __$__4(__then) {
              if (context.site.slot) {
                return createSiteSlot(__cb(_, __frame, 48, 12, __then, true));
              }
               else {
                return createSite(__cb(_, __frame, 50, 12, __then, true));
              }
              ;
            })(function __$__4() {
              return (function __$__4(__then) {
                if ((options.git || options.github)) {
                  ...
                  ;
                  return context.lvcClient.init(context, __cb(_, __frame, 61, 30, function __$__4() {
                    return utils.copyIisNodeWhenServerJsPresent(log, ".", __cb(_, __frame, 64, 18, function __$__4() {
                      return updateLocalConfigWithSiteName(__cb(_, __frame, 65, 12, function __$__4() {
                        return context.lvcClient.deploy(context, __cb(_, __frame, 66, 30, __then, true));
                      }, true));
                    }, true));
                  }, true));
                }
                  ...
                  context.lvcClient = linkedRevisionControl.createClient(cli, "git", websiteClient);
                  return context.lvcClient.determineIfCurrentDirectoryIsGitWorkingTree(context, __cb(_, __frame, 71, 30, function __$__4() {
                    return (function __$__4(__then) {
                      if (context.flags.isGitWorkingTree) {
                        return context.lvcClient.scaffoldGitIgnore(__cb(_, __frame, 74, 32, __then, true));
                      }
                       else {
                        __then();
                      }
  ...
  location.command("list").description($("List locations available for your account")).execute(function __5(options, _) {
    ...
    return __func(_, this, arguments, __5, 1, __frame, function __$__5() {
      ...
      return site.doAvailableLocationsGet(context, __cb(_, __frame, 5, 31, function ___(__0, __1) {
        locations = __1;
  ...
  site.command("browse [name]").description($("Open your web site in a browser")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __6(name, options, _) {
    var parsedSiteName, context, cache, siteData, href;
    var __frame = {
      name: "__6",
      line: 438
    };
    return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 10, 27, function ___(__0, __2) {
        cache = __2;
        return (function __$__6(_) {
          var __1 = cache;
          if (__1) {
            return _(null, __1);
          }
          ;
          return site.doSiteGet(context, __cb(_, __frame, 11, 39, _, true));
        })(__cb(_, __frame, -437, 18, function ___(__0, __3) {
          siteData = __3;
          return (function __$__6(__then) {
            if (((siteData && siteData.hostNames) && (siteData.hostNames.length > 0))) {
              href = ("http://" + siteData.hostNames[0]);
              return cli.interaction.launchBrowser(href, __cb(_, __frame, 15, 28, __then, true));
            }
             else {
              return _(new Error(util.format("Site %s does not exist or has no hostnames", name)));
            }
            ;
          })(_);
        }, true));
  ...
  site.command("show [name]").description($("Show details for a web site")).option("-d, --details", $("show additional site details")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __7(name, options, _) {
    var parsedSiteName, context, websiteClient, result, repositoryUri, gitUri, settings, diagnosticsSettings, siteInstances, data, showProperty, index, dSetting;
    var __frame = {
      name: "__7",
      line: 464
    };
    return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 11, 15, function __$__7() {
        ...
        return async.parallel([function __1(_) {
          var __frame = {
            name: "__1",
            line: 481
          };
          ...
          return __func(_, this, arguments, __2, 0, __frame, function __$__2() {
            return site.doSiteConfigGet(context, __cb(_, __frame, 0, 39, _, true));
          });
        },], __cb(_, __frame, 16, 29, function ___(__0, __3) {
          result = __3;
          ...
          return (function __$__7(__then) {
                ...
                (function ___(_) {
                  __tryCatch(_, function __$__7() {
                    return site.ensureRepositoryUri(context, __cb(_, __frame, 29, 19, function __$__7() {
                      return site.category("repository").doSettingsGet(context, __cb(_, __frame, 30, 53, function ___(__0, __4) {
                        settings = __4;
                        return websiteClient.getDiagnosticsSettings(context, __cb(_, __frame, 31, 50, function ___(__0, __5) {
                          diagnosticsSettings = __5;
                          __then();
                        }, true));
                      }, true));
                    }, true));
            ...
            return (function ___(__then) {
              (function ___(_) {
                __tryCatch(_, function __$__7() {
                  return site.doSiteInstancesGet(context, __cb(_, __frame, 40, 33, function ___(__0, __6) {
                    siteInstances = __6;
                    __then();
                  }, true));
                });
  ...
  site.command("delete [name]").description($("Delete a web site")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __8(name, options, _) {
    var parsedSiteName, context, progress, service, siteName;
    var __frame = {
      name: "__8",
      line: 661
    };
    return __func(_, this, arguments, __8, 2, __frame, function __$__8() {
      ...
      ;
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 14, 15, function __$__8() {
        return (function __$__8(__then) {
          if (!options.quiet) {
            return (function __$__8(__then) {
              if (!context.site.slot) {
                return cli.interaction.confirm(util.format("Delete site %s? [y/n] ", context.site.name), __cb(_, __frame, 18, 35, function ___(__0, __2) {
                  var __1 = !__2;
                  return (function __$__8(__then) {
                    if (__1) {
                      return _(null);
                ...
                return cli.interaction.confirm(util.format("Delete site %s in slot %s? [y/n] ", context.site.name, context.site.slot), __cb(_, __frame, 21, 40, function ___(__0, __4) {
                  var __3 = !__4;
                  return (function __$__8(__then) {
                    if (__3) {
                      return _(null);
          ...
          progress = cli.interaction.progress($("Deleting site"));
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$__8() {
                ...
                }, __cb(_, __frame, 31, 29, function __$__8() {
                  return cacheUtils.deleteSite(context.subscription, siteName, __cb(_, __frame, 37, 23, function __$__8() {
                    _(null, null, true);
                  }, true));
                }, true));
              });
  ...
  site.command("swap <name> [slot1] [slot2]").description($("Swap two web site slots")).option("-q, --quiet", $("quiet mode, do not ask for swap confirmation")).option("-s, --subscription <id>", $("the subscription id")).execute(function __9(name, slot1, slot2, options, _) {
    var parsedSiteName, context, sites, slots, verifySlotExists, progress, service;
    var __frame = {
      name: "__9",
      line: 710
    };
    return __func(_, this, arguments, __9, 4, __frame, function __$__9() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 13, 15, function __$__9() {
        return site.doSitesGet(context, __cb(_, __frame, 15, 27, function ___(__0, __2) {
          sites = __2;
          slots = [];
          ...
          if ((slots.length < 2)) {
            return _(new Error($("The website must have at least two slots to apply swap")));
          }
           else {
          ...
          if ((slots.length === 2)) {
            ...
            if (utils.ignoreCaseEquals(slot1, slot2)) {
              return _(new Error($("Specified slots must be different")));
            }
            ;
          }
          ;
          return (function __$__9(_) {
            ...
            ;
            return cli.interaction.confirm(util.format($("Swap slot \"%s\" from site \"%s\" with slot \"%s\" ? [y/n] "), slot1, context.site.name, slot2), __cb(_, __frame, 57, 49, function ___(__0, __3) {
              var __2 = !__3;
              return _(null, __2);
            }, true));
          })(__cb(_, __frame, -709, 18, function ___(__0, __3) {
            return (function __$__9(__then) {
              ...
              progress = cli.interaction.progress(util.format($("Swapping slot \"%s\" from site \"%s\" with slot \"%s\""), slot1, context.site.name, slot2));
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$__9() {
                    service = createWebsiteManagementService(context.subscription);
                    return service.webSites.swapSlots(context.site.webspace, context.site.name, slot1, slot2, __cb(_, __frame, 65, 29, function __$__9() {
                      _(null, null, true);
                    }, true));
                  });
                })(function ___(__e, __r, __cont) {
  ...
  site.command("start [name]").description($("Start a web site")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __10(name, options, _) {
    var parsedSiteName, context;
    var __frame = {
      name: "__10",
      line: 787
    };
    return __func(_, this, arguments, __10, 2, __frame, function __$__10() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 10, 15, function __$__10() {
        ...
        return site.doSitePUT(context, {
          state: "Running"
        }, __cb(_, __frame, 14, 15, function __$__10() {
  ...
  site.command("stop [name]").description($("Stop a web site")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __11(name, options, _) {
    var parsedSiteName, context;
    var __frame = {
      name: "__11",
      line: 810
    };
    return __func(_, this, arguments, __11, 2, __frame, function __$__11() {
      parsedSiteName = WebsitesClient.parseSiteName(name);
      context = {
        subscription: profile.current.getSubscription(options.subscription).id,
        site: {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 10, 15, function __$__11() {
        ...
        return site.doSitePUT(context, {
          state: "Stopped"
        }, __cb(_, __frame, 14, 15, function __$__11() {
  ...
  site.command("restart [name]").description($("Stop and then start a web site")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __12(name, options, _) {
    var parsedSiteName, context;
    var __frame = {
      name: "__12",
      line: 833
    };
    return __func(_, this, arguments, __12, 2, __frame, function __$__12() {
      parsedSiteName = WebsitesClient.parseSiteName(name);
      context = {
        subscription: profile.current.getSubscription(options.subscription).id,
        site: {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 10, 15, function __$__12() {
        ...
        return site.doSitePUT(context, {
          state: "Stopped"
        }, __cb(_, __frame, 13, 15, function __$__12() {
          log.info(util.format($("Site %s has been stopped, restarting"), context.site.name));
          return site.doSitePUT(context, {
            state: "Running"
          }, __cb(_, __frame, 16, 15, function __$__12() {
