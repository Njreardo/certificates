...
exports.init = function(cli) {
  ...
  tableSas.command("create [table] [permissions] [expiry]").description($("Generate a shared access signature of storage table")).option("--table <table>", $("the storage table name")).option("--permissions <permissions>", $("the operation permissions combining symbols of r(Query)/a(Add)/u(Update)/d(Delete)")).option("--start <start>", $("the UTC time at which the SAS becomes valid")).option("--expiry <expiry>", $("the UTC time at which the SAS expires")).option("--policy <policy>", $("the stored access policy identifier")).option("--start-pk <startPk>", $("the inclusive starting partition key")).option("--end-pk <endPk>", $("the inclusive ending partition key")).option("--start-rk <startRk>", $("the inclusive starting row key")).option("--end-rk <endRk>", $("the inclusive ending row key")).addStorageAccountOption().execute(createTableSAS);
  ...
  function createTable(table, options, _) {
    var tableService, operation, tips, storageOptions, created;
    var __frame = {
      name: "createTable",
      line: 209
    };
    return __func(_, this, arguments, createTable, 2, __frame, function __$createTable() {
      tableService = getTableServiceClient(options);
      return interaction.promptIfNotGiven($("Table name: "), table, __cb(_, __frame, 2, 24, function ___(__0, __1) {
        table = __1;
        ...
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$createTable() {
              return performStorageOperation(operation, __cb(_, __frame, 8, 20, function ___(__0, __2) {
                created = __2;
                if ((created === false)) {
                  return _(new Error(util.format($("Table '%s' already exists"), table)));
                }
                ;
                _(null, null, true);
              }, true), table, storageOptions);
            });
          ...
          __tryCatch(_, function __$createTable() {
            ...
            return showTable(table, StorageUtil.getStorageAccountOptions(options), __cb(_, __frame, 18, 4, function __$createTable() {
              _();
            }, true));
          });
        });
  ...
  function deleteTable(table, options, _) {
    var tableService, operation, tips, storageOptions;
    var __frame = {
      name: "deleteTable",
      line: 236
    };
    return __func(_, this, arguments, deleteTable, 2, __frame, function __$deleteTable() {
      tableService = getTableServiceClient(options);
      return interaction.promptIfNotGiven($("Table name: "), table, __cb(_, __frame, 2, 24, function ___(__0, __1) {
        table = __1;
        ...
        storageOptions = getStorageTableOperationDefaultOption();
        return (function __$deleteTable(__then) {
          if (!options.quiet) {
            return interaction.confirm(util.format($("Do you want to delete table %s? "), table), __cb(_, __frame, 8, 23, function ___(__0, __3) {
              var __2 = !__3;
              return (function __$deleteTable(__then) {
                if (__2) {
                  return _(null);
          ...
          ;
        })(function __$deleteTable() {
          startProgress(tips);
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$deleteTable() {
                return (function ___(__then) {
                  (function ___(_) {
                    __tryCatch(_, function __$deleteTable() {
                      return performStorageOperation(operation, __cb(_, __frame, 16, 6, __then, true), table, storageOptions);
                    });
                  })(function ___(e, __result) {
                    __catch(function __$deleteTable() {
                      if (e) {
  ...
  function showTable(table, options, _) {
    var tableService, operation, tips, storageOptions, output, exist, info, acl;
    var __frame = {
      name: "showTable",
      line: 272
    };
    return __func(_, this, arguments, showTable, 2, __frame, function __$showTable() {
      tableService = getTableServiceClient(options);
      return interaction.promptIfNotGiven($("Table name: "), table, __cb(_, __frame, 2, 24, function ___(__0, __1) {
        table = __1;
        ...
        return (function ___(__then) {
          (function ___(_) {
            __tryCatch(_, function __$showTable() {
              return (function ___(__then) {
                (function ___(_) {
                  __tryCatch(_, function __$showTable() {
                    return performStorageOperation(operation, __cb(_, __frame, 10, 18, function ___(__0, __2) {
                      exist = __2;
                      return (function __$showTable(__then) {
                        if (!exist) {
                          ...
                          return (function __$showTable(__then) {
                            if (!options.sas) {
                              return performStorageOperation(operation, __cb(_, __frame, 17, 20, function ___(__0, __3) {
                                acl = __3;
  ...
  function listTable(prefix, options, _) {
    var tableService, listOperation, tips, tableOptions, useWildcard, tables;
    var __frame = {
      name: "listTable",
      line: 326
    };
    return __func(_, this, arguments, listTable, 2, __frame, function __$listTable() {
      tableService = getTableServiceClient(options);
      ...
      return (function ___(__then) {
        (function ___(_) {
          __tryCatch(_, function __$listTable() {
            return performStorageOperation(listOperation, __cb(_, __frame, 18, 6, function ___(__0, __2) {
              return __2.forEach_(__cb(_, __frame, 18, 62, function __$listTable() {
                _(null, null, true);
              }, true), StorageUtil.opConcurrency, function __1(_, table) {
                var info;
                var __frame = {
                  name: "__1",
                  line: 344
  ...
  function createTableSAS(table, permissions, expiry, options, _) {
    var tableService, start, tableField, output, sharedAccessPolicy, tips;
    var __frame = {
      name: "createTableSAS",
      line: 369
    };
    return __func(_, this, arguments, createTableSAS, 4, __frame, function __$createTableSAS() {
      tableService = getTableServiceClient(options);
      return interaction.promptIfNotGiven($("Table name: "), table, __cb(_, __frame, 2, 24, function ___(__0, __1) {
        table = __1;
        return (function __$createTableSAS(__then) {
          if (!options.policy) {
            return interaction.promptIfNotGiven($("Permissions: "), permissions, __cb(_, __frame, 5, 32, function ___(__0, __2) {
              permissions = __2;
              StorageUtil.validatePermissions(StorageUtil.AccessType.Table, permissions);
              return interaction.promptIfNotGiven($("Expiry: "), expiry, __cb(_, __frame, 8, 27, function ___(__0, __3) {
                expiry = __3;
          ...
          sharedAccessPolicy = StorageUtil.getSharedAccessPolicy(permissions, start, expiry, tableField, options.policy);
          tips = util.format($("Creating shared access signature for table %s"), table);
          startProgress(tips);
          return (function ___(__then) {
            (function ___(_) {
              __tryCatch(_, function __$createTableSAS() {
  ...
  function createTablePolicy(table, name, options, _) {
    ...
    var __frame = {
      name: "createTablePolicy",
      line: 425
    };
    return __func(_, this, arguments, createTablePolicy, 3, __frame, function __$createTablePolicy() {
      createPolicySettings = createTablePolicySetting(options);
      return interaction.promptIfNotGiven($("Table name: "), table, __cb(_, __frame, 2, 52, function ___(__0, __1) {
  ...
  function listTablePolicy(table, options, _) {
    ...
    var __frame = {
      name: "listTablePolicy",
      line: 445
    };
    return __func(_, this, arguments, listTablePolicy, 2, __frame, function __$listTablePolicy() {
      listPolicySettings = createTablePolicySetting(options);
      return interaction.promptIfNotGiven($("Table name: "), table, __cb(_, __frame, 2, 50, function ___(__0, __1) {
  ...
  function showTablePolicy(table, name, options, _) {
    ...
    var __frame = {
      name: "showTablePolicy",
      line: 463
    };
    return __func(_, this, arguments, showTablePolicy, 3, __frame, function __$showTablePolicy() {
  ...
  function setTablePolicy(table, name, options, _) {
    ...
    return __func(_, this, arguments, setTablePolicy, 3, __frame, function __$setTablePolicy() {
      setPolicySettings = createTablePolicySetting(options);
      return interaction.promptIfNotGiven($("Table name: "), table, __cb(_, __frame, 2, 49, function ___(__0, __1) {
  ...
  function deleteTablePolicy(table, name, options, _) {
    ...
    return __func(_, this, arguments, deleteTablePolicy, 3, __frame, function __$deleteTablePolicy() {
