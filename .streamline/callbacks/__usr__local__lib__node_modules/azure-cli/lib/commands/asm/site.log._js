...
exports.init = function(cli) {
  ...
  diagnostic.command("download [name]").description($("Download diagnostic log")).option("-o, --output <path>", $("the output path, default is local folder")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(name, options, _) {
    ...
    return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
      ...
      return (function __$__1(__then) {
        if (utils.pathExistsSync(context.path)) {
          return util.format($("Replace existing %s ? [y/n] ", context.path), __cb(_, __frame, 20, 42, function ___(__0, __2) {
            var __1 = !cli.interaction.confirm(__2);
            return (function __$__1(__then) {
              if (__1) {
                return _(null);
              }
        ...
        return site.ensureRepositoryUri(context, __cb(_, __frame, 25, 31, function ___(__0, __3) {
          repositoryUri = __3;
          return (function __$__1(__then) {
            if (repositoryUri) {
              return doDownloadDiagnostic(context, __cb(_, __frame, 27, 8, __then, true));
            }
             else {
    ...
    return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      return site.ensureRepositoryUri(context, __cb(_, __frame, 12, 31, function ___(__0, __1) {
        ...
        return (function __$__2(__then) {
          if (repositoryUri) {
            return doLogStream(context, __cb(_, __frame, 14, 18, function ___(__0, __2) {
              buf = __2;
              log.info(buf);
              __then();
            }, true), function(err, line) {
              if (options.log) {
                log.data(line);
              }
               else {
  ...
  diagnostic.command("set [name]").description($("Configure diagnostics")).option("-a, --application", $("use this flag to enable application diagnostics.")).option("-A, --disable-application", $("use this flag to disable application diagnostics.")).option("-w, --web-server-logging", $("use this flag to enable web server logging.")).option("-W, --disable-web-server-logging", $("use this flag to disable web server logging.")).option("-e, --detailed-error-messages", $("use this flag to enable detailed error messages.")).option("-E, --disable-detailed-error-messages", $("use this flag to disable detailed error messages.")).option("-f, --failed-request-tracing", $("use this flag to enable failed request tracing.")).option("-F, --disable-failed-request-tracing", $("use this flag to disable failed request tracing.")).option("-o, --out <out>", $("takes file or storage. When -a is specified, use this parameter to specify the output of the log.")).option("-l, --level <level>", $("takes error, warning, verbose or info. When -a is specified, use this parameter to specify the log level. But default is error.")).option("-t, --storage-account <storage-account>", $("use this parameter to specify the storage account where the log will be stored.")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __3(name, options, _) {
    ...
    return __func(_, this, arguments, __3, 2, __frame, function __$__3() {
      if (!((((((((options.webServerLogging || options.disableWebServerLogging) || options.detailedErrorMessages) || options.disableDetailedErrorMessages) || options.failedRequestTracing) || options.disableFailedRequestTracing) || options.application) || options.disableApplication))) {
        return _(new Error($("Command needs to perform at least one diagnostic change")));
      }
      ;
        ...
        if ((options.application || options.disableApplication)) {
          return (function __$__3(__then) {
            if (options.application) {
              ...
              }, __cb(_, __frame, 14, 40, function ___(__0, __1) {
                options.out = __1;
                return (function __$__3(__then) {
                  if ((options.out === "storage")) {
                    ...
                    }, __cb(_, __frame, 20, 53, function ___(__0, __2) {
                      options.storageAccount = __2;
                      __then();
                    }, true));
                  }
                   else {
            ...
            websitesClient = new WebsitesClient(cli, subscriptionId);
            return (function __$__3(__then) {
              if ((options.application === true)) {
                return websitesClient.enableApplicationDiagnostic(name, options.out, {
                  level: options.level,
                  storageAccount: options.storageAccount
                }, __cb(_, __frame, 54, 25, __then, true));
              }
               else {
                return (function __$__3(__then) {
                  if ((options.disableApplication === true)) {
                    return websitesClient.disableApplicationDiagnostic(name, options.out, {
                      level: options.level,
                      storageAccount: options.storageAccount
                    }, __cb(_, __frame, 56, 25, __then, true));
                  }
                   else {
                    __then();
                  }
        ...
        return (function __$__3(__then) {
          if ((((((options.webServerLogging || options.disableWebServerLogging) || options.detailedErrorMessages) || options.disableDetailedErrorMessages) || options.failedRequestTracing) || options.disableFailedRequestTracing)) {
            ...
            return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 76, 13, function __$__3() {
              ...
              ;
              return site.doSiteConfigPUT(config, context, __cb(_, __frame, 91, 13, __then, true));
            }, true));
          }
           else {
            __then();
  ...
  function doLogStream(context, _, chunkcb) {
    ...
    return __func(_, this, arguments, doLogStream, 1, __frame, function __$doLogStream() {
      ...
      ;
      return service.getLogStream(context.path, {
        filter: context.filter
      }, chunkcb, __cb(_, __frame, 8, 19, _, true));
    });
  };
};