...
exports.init = function(cli) {
  ...
  account.command("list").description($("List the imported subscriptions")).execute(function __1(options, _) {
    var subscriptions, cfg;
    var __frame = {
      name: "__1",
      line: 43
    };
  ...
  account.command("show [subscriptionNameOrId]").description($("Show details about a subscription")).option("-s --subscriptionNameOrId <subscriptionNameOrId>", $("The subscription to show")).option("-d --details", $("Show extra information about the subscription")).execute(function __2(subscriptionNameOrId, options, _) {
    var subscriptions;
    var __frame = {
      name: "__2",
      line: 57
      ...
      cli.interaction.formatOutput(subscriptions, function(data) {
        for (var i = 0; (i < data.length); i++) {
          ...
          if (options.details) {
            ...
            log.data($("Registered ARM Namespaces   :"), data[i].registeredResourceNamespaces);
          }
          ;
          log.data("");
        };
  ...
  account.command("set <subscriptionNameOrId>").description($("Set the current subscription")).execute(function __3(subscriptionNameOrId, options, _) {
    var subscriptions, newSubscription;
    var __frame = {
      name: "__3",
      line: 92
    };
  ...
  account.command("clear").description($("Remove a subscription or environment, or clear all of the stored account and environment info")).option("-s --subscription <subscriptionNameOrId>", $("Subscription name or id to remove")).option("-e --environment <environmentName>", $("Environment name to remove")).option("-q --quiet", $("quiet mode, do not ask for delete confirmation")).execute(function __4(options, _) {
    var matchSubscription, matchEnvironment, clearAll, shouldClear;
    var __frame = {
      name: "__4",
      line: 121
    };
    return __func(_, this, arguments, __4, 1, __frame, function __$__4() {
      matchSubscription = function() {
        return false;
      };
      matchEnvironment = function() {
        return false;
      };
      clearAll = false;
      return (function __$__4(__then) {
        if ((!options.subscription && !options.environment)) {
          ...
          return (function __$__4(_) {
            ...
            ;
            return cli.interaction.confirm($("This will clear all account information. Are you sure? "), __cb(_, __frame, 7, 59, _, true));
          })(__cb(_, __frame, -120, 18, function ___(__0, __2) {
            shouldClear = __2;
            if (!shouldClear) {
              return _(null);
            }
        ...
        return (function __$__4(__then) {
          if (clearAll) {
            ...
            return tokenCache.clear(__cb(_, __frame, 41, 19, __then, true));
          }
           else {
            __then();
          }
  ...
  if (cli.isAsmMode()) {
    account.command("import <file>").description($("Import a publishsettings file or certificate for your account")).option("--skipregister", $("skip registering resources")).execute(function __5(file, options, _) {
      var __frame = {
        name: "__5",
        line: 170
      };
      return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
        if ((cli.getMode().toLowerCase() === "asm")) {
    ...
    account.command("download").description($("Launch a browser to download your publishsettings file")).option("-e, --environment <environment>", $("the publish settings download environment")).option("-r, --realm <realm>", $("the organization's realm")).execute(function __6(options, _) {
      var url;
      var __frame = {
        name: "__6",
        line: 181
